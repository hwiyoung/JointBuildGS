...
Run in the repository container:
    python -m unittest phases/p2-gsjso/scripts/test_pilot_1wave_reference_assets.py
"""
...
SCRIPT = Path(__file__).with_name("pilot_1wave_reference_assets.py")
LOCK = Path(__file__).parents[1] / "configs" / "pilot_1wave_reference_lock.json"
