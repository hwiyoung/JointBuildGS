...
FIG_DIR = REPO / "figs/e5_c001_3b_s1"
READOUT_FIG_DIR = FIG_DIR / "readout"
REPORT_PATH = REPO / "docs/W_E5_C001_③b_S1_표면복원.md"
TEMP_READOUT_REPORT = REPO / "docs/W_E5_C001_3b_S1_readout_tmp.md"
...
def configure_ablation_module() -> None:
    ...
    ab.COVERAGE_CSV = REPO / "docs/e5_c001_3b_s1_coverage.csv"
    ab.FILTER_CSV = REPO / "docs/e5_c001_3b_s1_filter_contrib.csv"
    ab.METRICS_CSV = REPO / "docs/e5_c001_3b_s1_metrics.csv"
    ab.SUMMARY_CSV = REPO / "docs/e5_c001_3b_s1_summary.csv"
    ab.TRADEOFF_CSV = REPO / "docs/e5_c001_3b_s1_tradeoff.csv"
    ab.CASE_CSV = REPO / "docs/e5_c001_3b_s1_representative_buildings.csv"
    ab.INVENTORY_CSV = REPO / "docs/e5_c001_3b_s1_inventory.csv"
    ab.ISSUES_CSV = REPO / "docs/e5_c001_3b_s1_issues.csv"
    ab.RENDER_COVERAGE = REPO / "docs/e5_c001_3b_s1_render_readout_coverage.csv"
    ab.SETTINGS = [
...
def build_delta_rows() -> list[dict[str, Any]]:
    s0_metrics = read_csv(REPO / "docs/e5_c001_8way_metrics.csv")
    s1_metrics = read_csv(ab.METRICS_CSV)
    s0_cov = read_csv(REPO / "docs/e5_c001_render_readout_coverage.csv")
    ...
    for arm, s1_run in [(arm_from_s1_run(r), r) for r in S1_RUN_NAMES]:
        ...
        rows.append(row)
    write_csv(REPO / "docs/e5_c001_3b_s1_delta.csv", rows)
    return rows
...
def build_texture_rows() -> list[dict[str, Any]]:
    ...
    write_csv(REPO / "docs/e5_c001_3b_s1_texture_strata.csv", rows)
    return rows
...
def build_voxel_rows() -> list[dict[str, Any]]:
    ...
    write_csv(REPO / "docs/e5_c001_3b_s1_voxel02.csv", rows)
    return rows
...
def plot_floater() -> Path | None:
    s0_path = REPO / "docs/e5_c001_render_floater_metrics.csv"
    s1_path = REPO / "docs/e5_c001_3b_s1_render_floater_metrics.csv"
    s1_render_path = REPO / "docs/e5_c001_3b_s1_render_eval_metrics.csv"
...
def plot_render_tsdf() -> Path | None:
    s0_path = REPO / "docs/e5_c001_render_readout_coverage.csv"
    s1_path = REPO / "docs/e5_c001_3b_s1_render_readout_coverage.csv"
...
def make_case_panels() -> list[Path]:
    ...
    metric_rows = read_csv(REPO / "docs/e5_c001_8way_metrics.csv") + read_csv(ab.METRICS_CSV)
...
def write_versions(figures: list[Path]) -> None:
    ...
    lines = [
        ...
        "outputs:",
        f"- {rel(REPORT_PATH)}",
        "- docs/e5_c001_3b_s1_delta.csv",
        "- docs/e5_c001_3b_s1_texture_strata.csv",
        "- docs/e5_c001_3b_s1_voxel02.csv",
...
def build_report() -> None:
    ...
    if (REPO / "docs/e5_c001_3b_s1_render_floater_metrics.csv").exists():
        s1f = read_csv(REPO / "docs/e5_c001_3b_s1_render_floater_metrics.csv")
        s0f = [r for r in read_csv(REPO / "docs/e5_c001_render_floater_metrics.csv") if r.get("replicate") == "r1"]
    ...
    lines = [
        ...
        "",
        f"- S1 base↔voxel02 건물별 표: `docs/e5_c001_3b_s1_voxel02.csv`.",
        ...
        "## 산출물",
        "",
        f"- 수치표: `{rel(ab.METRICS_CSV)}`, `{rel(ab.COVERAGE_CSV)}`, `docs/e5_c001_3b_s1_delta.csv`, `docs/e5_c001_3b_s1_texture_strata.csv`, `docs/e5_c001_3b_s1_voxel02.csv`.",
