...
def write_versions(path: Path, args, provenance: dict[str, str], rows: list[dict[str, object]], fps: dict[str, tuple[str, str]]) -> None:
    ...
    lines += [
        ...
        "",
        "outputs:",
        "  docs/pointcloud_attributes_v1_1.csv",
...
def build_v11_section(
    ...
    lines: list[str] = [
        ...
        f"- v1의 +48.0은 `phases/p2-gsjso/scripts/tum_mob_raw_to_npz.py`와 `docs/W_pointcloud_attributes.md`의 ACMP/LiDAR raw-arm 관행값이다. v1.1에서는 orthometric ACMP/ALS에 +{HEIGHT_CONSTANT_M:.3f} m를 썼다.",
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--v1-csv", default="docs/pointcloud_attributes_v1.csv")
    ap.add_argument("--out-csv", default="docs/pointcloud_attributes_v1_1.csv")
