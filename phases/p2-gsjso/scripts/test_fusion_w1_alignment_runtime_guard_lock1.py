...
SCRIPT = Path(__file__).with_name(
    "fusion_w1_alignment_runtime_guard_lock1.py"
)
...
CONFIG_PATH = (
    REPO / "phases/p2-gsjso/configs/fusion_w1_alignment_gate_lock1.json"
)
WRAPPER_PATH = (
    REPO / "phases/p2-gsjso/scripts/run_fusion_w1_alignment_gate_lock1.sh"
)
