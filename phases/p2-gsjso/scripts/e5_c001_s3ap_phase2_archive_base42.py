...
DEFAULT_RUN_ROOT = Path("phases/p2-gsjso/runs/20260715_e5_c001_s3ap_phase2_prepare")
...
DEFAULT_LOCK = Path("phases/p2-gsjso/configs/e5_c001_s3ap_phase2_lock.json")
...
HOST_LAUNCHER = "phases/p2-gsjso/scripts/run_e5_c001_s3ap_phase2.sh"
ARCHIVE_LAUNCHER = (
    "phases/p2-gsjso/scripts/run_e5_c001_s3ap_phase2_archive_base42.sh"
)
PREWARM_SCRIPT = "phases/p2-gsjso/scripts/e5_c001_s3ap_gsplat_prewarm.py"
PREWARM_MANIFEST = (
    ...
    for row in rows:
        ...
        if row["arm"] == "a0":
            row["surface_seed_npz"] = (
                "phases/p2-gsjso/runs/20260715_e5_c001_s3ap_phase1_seedprep/"
