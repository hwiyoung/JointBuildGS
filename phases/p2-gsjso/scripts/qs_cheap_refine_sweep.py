...
Run from the repository root::
    ...
    python3 phases/p2-gsjso/scripts/qs_cheap_refine_sweep.py run
...
D_RUN = (
    REPO
    / "phases/p2-gsjso/runs/20260717_qs_cheap_refine_pilot"
)
...
METRIC_SCRIPT = REPO / "phases/p2-gsjso/scripts/e5_c001_8way.py"
SMOOTH_SCRIPT = REPO / "phases/p2-gsjso/scripts/overseg_smooth.py"
D_SCRIPT = REPO / "phases/p2-gsjso/scripts/qs_cheap_refine_pilot.py"
GATE_SCRIPT = REPO / "phases/p2-gsjso/scripts/e5_pilot_gate_tools.py"
...
def finalize() -> None:
    ...
    gate = load_module(
        "qs_cheap_sweep_gate",
        REPO / "phases/p2-gsjso/scripts/e5_pilot_gate_tools.py",
    )
