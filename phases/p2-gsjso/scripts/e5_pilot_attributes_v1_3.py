...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--input-csv", default="docs/pointcloud_attributes_v1_3.csv")
    parser.add_argument("--out-csv", default="docs/pointcloud_attributes_v1_3.csv")
    parser.add_argument("--check-json", default="docs/e5_pilot_pointcloud_attributes_v1_3_check.json")
