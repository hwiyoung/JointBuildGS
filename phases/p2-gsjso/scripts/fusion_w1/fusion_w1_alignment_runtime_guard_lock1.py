...
DEFAULT_CONFIG = (
    REPO_ROOT / "phases/p2-gsjso/configs/fusion_w1/fusion_w1_alignment_gate_lock1.json"
)
DEFAULT_RECEIPT = (
    REPO_ROOT
...
RUNTIME_FILES = (
    ...
    "phases/p2-gsjso/scripts/fusion_w1/run_fusion_w1_alignment_gate_lock1.sh",
    "tests/fusion_w1/test_fusion_w1_alignment_runtime_guard_lock1.py",
)
LOCKED_GATE_SCRIPT = (
...
def _implementation_paths(config: Mapping[str, Any]) -> list[str]:
    ...
    for path in RUNTIME_FILES:
        if path not in paths:
            paths.append(path)
    expected_minimum = {
        "phases/p2-gsjso/configs/fusion_w1/fusion_w1_alignment_gate_lock1.json",
        LOCKED_GATE_SCRIPT,
        "phases/p2-gsjso/scripts/fusion_w1/run_fusion_w1_alignment_gate_lock1.sh",
        "tests/fusion_w1/test_fusion_w1_alignment_gate_lock1.py",
        *RUNTIME_FILES,
    }
