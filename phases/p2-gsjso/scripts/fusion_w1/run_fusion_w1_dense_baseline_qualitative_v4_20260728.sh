#!/usr/bin/env bash
# Docker-only CPU wrapper for dense qualitative v4.
set -Eeuo pipefail
...
CONFIG="phases/p2-gsjso/configs/fusion_w1/fusion_w1_dense_baseline_qualitative_v4_20260728.json"
SCRIPT="phases/p2-gsjso/scripts/fusion_w1/fusion_w1_dense_baseline_qualitative_v4_20260728.py"
TEST="tests/fusion_w1/test_fusion_w1_dense_baseline_qualitative_v4_20260728.py"
OUTPUT_REL="phases/p2-gsjso/runs/20260728_fusion_w1_dense_baseline_qualitative_v4"
...
fail() {
  echo "dense baseline qualitative v4 wrapper error: $*" >&2
  exit 2
}
...
case "${1:-}" in
  ...
  test)
    ...
    run_read_only -c 'import laspy, lxml, matplotlib, numpy, PIL, shapely; from src.stage2 import image_projection; print("deps=ok")'
