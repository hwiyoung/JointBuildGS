#!/usr/bin/env bash
# Docker-only CPU wrapper for the reference-LoD2-boundary-only dense panel v3.
set -Eeuo pipefail
...
CONFIG="phases/p2-gsjso/configs/fusion_w1/fusion_w1_dense_baseline_qualitative_v3_20260728.json"
SCRIPT="phases/p2-gsjso/scripts/fusion_w1/fusion_w1_dense_baseline_qualitative_v3_20260728.py"
TEST="tests/fusion_w1/test_fusion_w1_dense_baseline_qualitative_v3_20260728.py"
OUTPUT_REL="phases/p2-gsjso/runs/20260728_fusion_w1_dense_baseline_qualitative_v3"
...
fail() {
  echo "dense baseline qualitative v3 wrapper error: $*" >&2
  exit 2
}
