...
DEFAULT_CONFIG = (
    REPO / "phases/p2-gsjso/configs/fusion_w1/fusion_w1_aprime_training_20260726.json"
)
...
def queue_next(
    *, repo: Path, config: Mapping[str, Any]
    ...
    if next_row is not None and next_row["state"] in {"NEEDS_MATERIALIZATION", "READY_TO_LAUNCH"}:
        ...
        command = [
            "phases/p2-gsjso/scripts/fusion_w1/run_fusion_w1_aprime_training_20260726.sh",
            action,
            "--building-id",
