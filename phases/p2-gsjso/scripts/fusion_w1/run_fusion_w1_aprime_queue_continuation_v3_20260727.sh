...
CONFIG="${APRIME_QUEUE_CONFIG:-phases/p2-gsjso/configs/fusion_w1/fusion_w1_aprime_queue_continuation_v3_20260727.json}"
DRIVER="${APRIME_QUEUE_DRIVER:-phases/p2-gsjso/scripts/fusion_w1/fusion_w1_aprime_queue_continuation_v3_20260727.py}"
TEST="${APRIME_QUEUE_TEST:-tests/fusion_w1/test_fusion_w1_aprime_queue_continuation_v3_20260727.py}"
TRAINING_WRAPPER=""
READOUT_WRAPPER=""
REVIEW_WRAPPER=""
QUALITATIVE_WRAPPER=""
