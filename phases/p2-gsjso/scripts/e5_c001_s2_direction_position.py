...
REPORT_PATH = REPO / "docs/W_E5_C001_S2_방향자리.md"
CHECKPOINT_REPORT = REPO / "docs/W_E5_C001_S2_checkpoint_20260710.md"

CSV_MONODEPTH = REPO / "docs/e5_c001_s2_monodepth_precheck.csv"
CSV_MONODEPTH_BUILDING = REPO / "docs/e5_c001_s2_monodepth_precheck_building.csv"
CSV_MONODEPTH_RESOLUTION = REPO / "docs/e5_c001_s2_monodepth_resolution.csv"
CSV_SHEET = REPO / "docs/e5_c001_s2_sheet_identity_alt.csv"
CSV_IMPL = REPO / "docs/e5_c001_s2_implementation_check.csv"
CSV_NORMAL_RECHECK = REPO / "docs/e5_c001_s2_normal_recheck.csv"
CSV_A5_PREP = REPO / "docs/e5_c001_s2_a5_metric_prep.csv"
CSV_GRAD_SHARE = REPO / "docs/e5_c001_s2_grad_share.csv"
CSV_TIMELINE = REPO / "docs/e5_c001_s2_timeline_roofcrop.csv"
CSV_ARM_CELLS = REPO / "docs/e5_c001_s2_arm_cells.csv"
CSV_405_REPAIR = REPO / "docs/e5_c001_s2_405_rescore.csv"
CSV_405_BUILDING = REPO / "docs/e5_c001_s2_405_rescore_building.csv"
CSV_GLOBAL_Z = REPO / "docs/e5_c001_s2_global_z_hist.csv"
CSV_REND_DIST = REPO / "docs/e5_c001_s2_rend_dist.csv"
CSV_PIPELINE_STRIPS = REPO / "docs/e5_c001_s2_pipeline_strips.csv"
CSV_INVENTORY = REPO / "docs/e5_c001_s2_inventory.csv"
CSV_ISSUES = REPO / "docs/e5_c001_s2_issues.csv"
...
def _infer_priors_container(args: argparse.Namespace) -> None:
    ...
    write_csv(REPO / "docs/e5_c001_s2_mono_runtime.csv", runtime_rows)
    if residual_gallery:
...
def infer_priors(args: argparse.Namespace) -> None:
    ...
    cmd = docker_base(args.gpu, {"E5_S2_PRIOR_CONTAINER": "1", "MPLCONFIGDIR": "/tmp/matplotlib"}) + [
        "python",
        "phases/p2-gsjso/scripts/e5_c001_s2_direction_position.py",
        "infer-priors",
        "--device",
        "cuda:0",
    ]
...
def implementation_check(_args: argparse.Namespace) -> None:
    ...
    rows = [
        ...
        },
        {
            ...
            "source": "phases/p2-gsjso/scripts/e5_c001_readout_extract_ablation.py; e5_c001_pipeline_strips.py",
        },
    ]
...
def normal_recheck(args: argparse.Namespace) -> None:
    ...
    before_rows = read_csv(REPO / "docs/e5_c001_s1_full_normal_precheck.csv")
    before_by = {short_id(r.get("building_id", "")): r for r in before_rows}
    if not before_rows:
        append_issue("A-4", "warn", "S1 normal precheck CSV missing; before/after table limited", REPO / "docs/e5_c001_s1_full_normal_precheck.csv")
...
def configure_ablation_module(include_arm3: bool | None = None) -> list[Arm]:
    ...
    ab.COVERAGE_CSV = REPO / "docs/e5_c001_s2_coverage.csv"
    ab.FILTER_CSV = REPO / "docs/e5_c001_s2_filter_contrib.csv"
    ab.METRICS_CSV = REPO / "docs/e5_c001_s2_405_rescore_building.csv"
    ab.SUMMARY_CSV = REPO / "docs/e5_c001_s2_summary.csv"
    ab.TRADEOFF_CSV = REPO / "docs/e5_c001_s2_tradeoff.csv"
    ab.CASE_CSV = REPO / "docs/e5_c001_s2_representative_buildings.csv"
    ab.INVENTORY_CSV = REPO / "docs/e5_c001_s2_readout_inventory.csv"
    ab.ISSUES_CSV = REPO / "docs/e5_c001_s2_readout_issues.csv"
...
def repair_405(args: argparse.Namespace) -> None:
    ...
    repair.CSV_BUILDING = REPO / "docs/e5_c001_s2_405_repair_status_building.csv"
    repair.CSV_ISSUES = REPO / "docs/e5_c001_s2_405_repair_issues.csv"
...
def s0_dense_count() -> int:
    rows = read_csv(REPO / "phases/p2-gsjso/runs/e5p_train_20260707_C001/train_fingerprints.csv")
    for row in rows:
