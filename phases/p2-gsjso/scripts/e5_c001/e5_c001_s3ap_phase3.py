...
DEFAULT_CONFIG = REPO / "phases/p2-gsjso/configs/e5_c001/e5_c001_s3ap_phase3_lock.json"
CONTAINER_REPO = Path("/workspace/JointBuildGS")
SCRIPT_REL = Path("phases/p2-gsjso/scripts/e5_c001/e5_c001_s3ap_phase3.py")
