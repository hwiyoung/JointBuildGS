...
def normalize_manifest_readout(manifest: dict[str, Any], status: str) -> None:
    ...
    for path in [
        Path(__file__),
        base.CONFIG,
        base.REPO / "phases/p2-gsjso/scripts/e5_c001/e5_c001_s3ap_phase0_baselines.py",
        base.REPO / "phases/p2-gsjso/scripts/e5_c001/run_e5_c001_s3ap_phase0_baselines.sh",
    ]:
