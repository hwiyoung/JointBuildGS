...
DEFAULT_PHASE3_LOCK = Path(
    "phases/p2-gsjso/configs/e5_c001/e5_c001_s3ap_phase3_lock.json"
)
DEFAULT_PHASE3_ARCHIVE_LOCK = Path(
    "phases/p2-gsjso/configs/e5_c001/e5_c001_s3ap_phase3_archive_lock.json"
)
DEFAULT_PHASE3_ARCHIVE_CONTROLLER = Path(
    "phases/p2-gsjso/scripts/e5_c001/e5_c001_s3ap_phase3_archive.py"
)
...
ARCHIVE_LAUNCHER = (
    "phases/p2-gsjso/scripts/e5_c001/run_e5_c001_s3ap_phase2_archive_tilt18.sh"
)
ARCHIVE_SCRIPT = (
    "phases/p2-gsjso/scripts/e5_c001/e5_c001_s3ap_phase2_archive_tilt18.py"
)
PHASE3_SCRIPT = "phases/p2-gsjso/scripts/e5_c001/e5_c001_s3ap_phase3.py"
TILT_GRID = (
    ("5.0", "p05"), ("-5.0", "m05"),
    ("10.0", "p10"), ("-10.0", "m10"),
    ("20.0", "p20"), ("-20.0", "m20"),
