...
METRICS = DOCS / "boundary_map_v2_metrics.csv"
LADDER = DOCS / "boundary_map_v2_ladder.csv"
CONFUSION = DOCS / "boundary_map_v2_confusion.csv"
CASES = DOCS / "boundary_map_v2_boundary_cases.csv"
CONDITIONAL = DOCS / "boundary_map_v2_conditional_targets.csv"
MANIFEST = DOCS / "boundary_map_v2_manifest.json"
SUMMARY = DOCS / "W_boundary_map_v2_summary_20260718.md"
FIGURE = DOCS / "figs/boundary_map_v2/boundary_map_v2_ladder.png"
...
POPULATION_AUX_SCRIPT = Path(__file__).with_name("population_aux_v3.py")
PROJECTION_DATUM_SCRIPT = Path(__file__).with_name("projection_datum.py")
...
LOWTEX_SCRIPT = Path(__file__).with_name("aux_v4b.py")
...
OLD_METRICS = DOCS / "boundary_map_metrics.csv"
