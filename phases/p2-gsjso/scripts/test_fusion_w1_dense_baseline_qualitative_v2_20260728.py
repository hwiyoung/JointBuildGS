...
MODULE_PATH = (
    REPO
    / "phases/p2-gsjso/scripts/fusion_w1_dense_baseline_qualitative_v2_20260728.py"
)
...
class DenseBaselineQualitativeV1Tests(unittest.TestCase):
    ...
    def test_population_is_dual_verified_canonical_114(self) -> None:
        ...
        self.assertIn(
            "phases/p2-gsjso/runs/20260719_boundary_map_v3/label_inventory.json",
            source_paths,
        )
        self.assertIn("docs/regression_input_snapshot.csv", source_paths)
    ...
    def test_photo_addresses_are_deferred_until_postselection_geometry_binding(self) -> None:
        source_paths = {record["path"] for record in self.result.source_records}
        self.assertIn("docs/boundary_map_v2_ladder.csv", source_paths)
    ...
    def test_wrapper_locks_network_cpu_dependencies_and_output_policy(self) -> None:
        wrapper = (
            REPO
            / "phases/p2-gsjso/scripts/run_fusion_w1_dense_baseline_qualitative_v2_20260728.sh"
    ...
    def test_projection_contract_is_explicit_and_legacy_p0_helper_is_absent(self) -> None:
        ...
        self.assertIn("phases/p2-gsjso/scripts/roof_boundary_overlay.py", implementation)
