...
REPORT_PATH = Path("docs/W_E5_C001_8way.md")
METRICS_CSV = Path("docs/e5_c001_8way_metrics.csv")
SOURCE_SUMMARY_CSV = Path("docs/e5_c001_8way_source_summary.csv")
CORRECTION_GAIN_CSV = Path("docs/e5_c001_8way_correction_gain.csv")
CORRECTION_GAIN_SUMMARY_CSV = Path("docs/e5_c001_8way_correction_gain_summary.csv")
STRATA_SUMMARY_CSV = Path("docs/e5_c001_8way_strata_summary.csv")
INVENTORY_CSV = Path("docs/e5_c001_8way_inventory.csv")
...
def write_report(
    ...
    lines = [
        ...
        f"- 기존 게이트 보고: `docs/W_E5_pilot_gate.md`, `docs/W_E5_pilot_gate_검수·판정회부_20260707.md`.",
