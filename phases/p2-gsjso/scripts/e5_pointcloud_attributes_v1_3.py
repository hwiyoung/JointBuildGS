...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--v1-2-csv", default="docs/pointcloud_attributes_v1_2.csv")
    parser.add_argument("--out-csv", default="docs/pointcloud_attributes_v1_3.csv")
    parser.add_argument("--check-json", default="docs/e5_pointcloud_attributes_v1_3_check.json")
    parser.add_argument("--population", default="docs/population_aux_v4.csv")
