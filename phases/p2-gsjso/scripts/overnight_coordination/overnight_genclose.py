...
E5_SCRIPT_DIR = REPO / "scripts/e5_c001"
PHASE_E5_SCRIPT_DIR = REPO / "phases/p2-gsjso/scripts/e5_c001"
for script_dir in (E5_SCRIPT_DIR, PHASE_E5_SCRIPT_DIR):
...
RUN_DIR = REPO / "phases/p2-gsjso/runs/quality_score" / RUN_ID
...
FIG_DIR = REPO / "docs/figs/genclose"
SCORE_CSV = REPO / "docs/experiments/evaluation/primary4_assembly_validation/tables/genclose_flat_seed_scores.csv"
ASSEMBLY_CSV = REPO / "docs/experiments/evaluation/primary4_assembly_validation/tables/genclose_density_assembly.csv"
DIRECT_CSV = REPO / "docs/experiments/evaluation/primary4_assembly_validation/tables/genclose_direct_plane.csv"
...
P0_SCORE = REPO / "docs/experiments/input-and-alignment/e5_c001_s3b0/tables/s3b0_p0prime_scores.csv"
PLANEFIT = REPO / "docs/experiments/input-and-alignment/e5_c001_s3ap/tables/planefit_baseline.csv"
