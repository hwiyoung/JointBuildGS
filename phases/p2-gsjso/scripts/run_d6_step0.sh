...
for arm in gs_d4_dense gs_d4_acmp; do
  for t in 4906969 42364659 4906972; do
    ...
    echo "  smrf $arm/$t"
    $TOOLS python3 phases/p2-gsjso/scripts/_mob_prep_las.py \
...
$TOOLS python3 phases/p2-gsjso/scripts/d6_overseg_diag.py

# ---- 3) component (c): Roofer epsilon / min-points sweep ----
echo "[3] d6_roofer_sweep.py (Roofer threshold sweep)"
python3 phases/p2-gsjso/scripts/d6_roofer_sweep.py
