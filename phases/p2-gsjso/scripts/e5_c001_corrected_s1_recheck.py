...
REPORT_PATH = REPO / "docs/W_E5_C001_corrected_S1_재점검.md"
...
CSV_SNAPSHOT_INVENTORY = REPO / "docs/e5_c001_corrected_s1_recheck_snapshot_inventory.csv"
CSV_CKPT_THRESHOLDS = REPO / "docs/e5_c001_corrected_s1_recheck_ckpt_thresholds.csv"
CSV_PRUNE_SWEEP = REPO / "docs/e5_c001_corrected_s1_recheck_prune_sweep.csv"
CSV_PREPRUNE_COVERAGE = REPO / "docs/e5_c001_corrected_s1_recheck_preprune_coverage.csv"
CSV_GAUSSIAN_ROOFCROP = REPO / "docs/e5_c001_corrected_s1_recheck_gaussian_roofcrop.csv"
CSV_VAL3DITY_TYPES = REPO / "docs/e5_c001_corrected_s1_recheck_val3dity_types.csv"
CSV_FLOATER_RENDER = REPO / "docs/e5_c001_corrected_s1_recheck_floater_render.csv"
CSV_MONO_NORMAL = REPO / "docs/e5_c001_corrected_s1_recheck_mono_normal_stats.csv"
CSV_ISSUES = REPO / "docs/e5_c001_corrected_s1_recheck_issues.csv"
CSV_CONFIG_DIFF = REPO / "docs/e5_c001_corrected_s1_recheck_config_diff.csv"
...
def configure() -> None:
    ...
    s1.ab.FILTER_CSV = REPO / "docs/e5_c001_corrected_s1_recheck_filter_contrib.csv"
    s1.ab.METRICS_CSV = REPO / "docs/e5_c001_corrected_s1_recheck_building_8way.csv"
    s1.ab.SUMMARY_CSV = REPO / "docs/e5_c001_corrected_s1_recheck_summary.csv"
    s1.ab.TRADEOFF_CSV = REPO / "docs/e5_c001_corrected_s1_recheck_tradeoff.csv"
    s1.ab.CASE_CSV = REPO / "docs/e5_c001_corrected_s1_recheck_representative_buildings.csv"
    s1.ab.INVENTORY_CSV = REPO / "docs/e5_c001_corrected_s1_recheck_inventory.csv"
    s1.ab.ISSUES_CSV = REPO / "docs/e5_c001_corrected_s1_recheck_readout_issues.csv"
...
def evaluate_or_container(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        cmd = [
            ...
            "python3",
            "phases/p2-gsjso/scripts/e5_c001_corrected_s1_recheck.py",
            "evaluate",
        ]
        if args.settings:
            cmd.append("--settings")
...
def build_metric_indices() -> dict[str, dict[tuple[str, str, str], dict[str, str]]]:
    ...
    paths = {
        "raw_s0": REPO / "docs/e5_c001_8way_metrics.csv",
        "s1": REPO / "docs/e5_c001_3b_s1_metrics.csv",
        "corrected": REPO / "docs/e5_c001_corrected_s1_building_8way.csv",
        "recheck": REPO / "docs/e5_c001_corrected_s1_recheck_building_8way.csv",
    }
...
def build_prune_sweep(_args: argparse.Namespace) -> None:
    metrics = read_csv(REPO / "docs/e5_c001_corrected_s1_recheck_building_8way.csv")
...
def copy_snapshots() -> None:
    ...
    for path in [
        ...
        REPO / "docs/e5_c001_corrected_s1_recheck_summary.csv",
        REPO / "docs/e5_c001_corrected_s1_recheck_filter_contrib.csv",
