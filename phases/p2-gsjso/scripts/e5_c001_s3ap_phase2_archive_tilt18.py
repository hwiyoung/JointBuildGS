...
def validate_phase3_base42_archive(
    *,
    ...
    exact_core_paths = {
        "scores": "docs/e5_c001_s3ap_phase3_scores.csv",
        "perturbation": "docs/e5_c001_s3ap_perturbation.csv",
        "cells": "docs/e5_c001_s3ap_perturbation_cells.csv",
...
def validate_trigger_contract(
    ...
    expected_values: dict[str, Any] = {
        ...
        "perturbation_cells_csv": "docs/e5_c001_s3ap_perturbation_cells.csv",
