...
from evidence_cards_v2 import DATA, GEOJSON, IMAGE_DIR, REPO, distort, gml_building, parse_cam_model, parse_cameras, to_cam  # noqa: E402
from projection_datum import describe_projection_config, projection_geoid_m  # noqa: E402
from projection_zeta_ls import (  # noqa: E402
    BUILDINGS,
...
OUT_CSV = REPO / "docs/projection_gate_v2.csv"
OUT_MD = REPO / "docs/projection_gate_v2.md"
...
def write_versions() -> None:
    ...
    text = "\n".join(
        [
            f"run_id: {RUN_ID}",
            f"git_head: {git_head()}",
            "command: python3 phases/p2-gsjso/scripts/projection_gate_v2.py",
