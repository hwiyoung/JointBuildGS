...
DOC_PAIRS="docs/anchor_census_supplement_pairs.csv"
DOC_MEASUREMENTS="docs/anchor_census_supplement_measurements.csv"
DOC_RELIABILITY="docs/anchor_census_supplement_same_block_reliability_pairs.csv"
LADDER="docs/boundary_map_v4_1_ladder.csv"
PUBLIC_MANIFEST="docs/anchor_census_supplement_manifest.json"
SUMMARY="docs/W_anchor_census_supplement_boundary_map_v4_1_summary_20260720.md"
