...
CONFIG_PATH="phases/p2-gsjso/configs/fusion_w1_alignment_gate_lock1.json"
GUARD_PATH="phases/p2-gsjso/runs/20260724_fusion_w1/w1_align2_execution_guard.json"
LOCK_PATH="phases/p2-gsjso/runs/20260724_fusion_w1/w1_align2_gate.lock"
HOST_UID="$(id -u)"
HOST_GID="$(id -g)"
