...
def write_lineage(path: Path, source_hash: dict[str, str]) -> None:
    rows = [
        (
            "현행 semantic class",
            "phases/p2-gsjso/scripts/make_clean_labels.py",
        ...
        (
            ...
            "phases/p2-gsjso/scripts/e5_c001_s3_semantic_regions.py",
        ...
        (
            "Phase-2 crop",
            "phases/p2-gsjso/scripts/e5_c001_s3ap_phase2_prepare.py",
...
def main() -> None:
    ...
    lineage_sources = [
        common.REPO / "phases/p2-gsjso/scripts/make_clean_labels.py",
        common.REPO / "phases/p2-gsjso/scripts/e5_c001_s3_semantic_regions.py",
        common.REPO / "phases/p2-gsjso/scripts/e5_c001_s3ap_phase2_prepare.py",
