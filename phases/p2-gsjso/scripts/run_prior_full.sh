...
# PREREQ: depth/normal maps staged at data_geoidfix/stereo (phases/p2-gsjso/scripts/prior_full_stereo.sh).
# Launch: setsid nohup bash phases/p2-gsjso/scripts/run_prior_full.sh > results/tum_transfer/mob/prior_full.log 2>&1 &
