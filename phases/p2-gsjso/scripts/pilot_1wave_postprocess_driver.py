...
SCORING = REPO / "phases/p2-gsjso/scripts/pilot_1wave_scoring.py"
LOSS_AGGREGATE = REPO / "phases/p2-gsjso/scripts/pilot_1wave_loss_cursor_aggregate.py"
BINDING_AUDIT = REPO / "phases/p2-gsjso/scripts/pilot_1wave_binding_audit.py"
...
REQUIRED_COMMITTED_PATHS = (
    ...
    Path("phases/p2-gsjso/scripts/pilot_1wave_scene_classify.py"),
    Path("phases/p2-gsjso/scripts/pilot_1wave_scoring.py"),
    Path("phases/p2-gsjso/scripts/pilot_1wave_loss_cursor_aggregate.py"),
    Path("phases/p2-gsjso/scripts/pilot_1wave_binding_audit.py"),
)
