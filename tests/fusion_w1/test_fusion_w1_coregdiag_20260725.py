...
SCRIPT = ROOT / "phases/p2-gsjso/scripts/fusion_w1/fusion_w1_coregdiag_20260725.py"
...
class CoregDiagnosticTests(unittest.TestCase):
    ...
    def test_learning_and_source_writes_are_forbidden(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "phases/p2-gsjso/configs/fusion_w1/fusion_w1_coregdiag_20260725.json",
                "phases/p2-gsjso/scripts/fusion_w1/fusion_w1_coregdiag_20260725.py",
                "phases/p2-gsjso/scripts/fusion_w1/run_fusion_w1_coregdiag_20260725.sh",
                "tests/fusion_w1/test_fusion_w1_coregdiag_20260725.py",
            },
        )
