...
SCRIPT = Path(__file__).resolve().parents[2] / "phases/p2-gsjso/scripts/fusion_w1/fusion_w1_aprime_tsdf_20260726.py"
SPEC = importlib.util.spec_from_file_location("aprime_tsdf", SCRIPT)
assert SPEC is not None and SPEC.loader is not None
MOD = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MOD)
SOURCE = SCRIPT.read_text(encoding="utf-8")
WRAPPER = SCRIPT.parent / "run_fusion_w1_aprime_t2_20260726.sh".read_text(
    encoding="utf-8"
)
...
class AprimeTsdfTests(unittest.TestCase):
    ...
    def test_wrapper_is_offline_bounded_and_nonroot(self) -> None:
        ...
        self.assertIn('RUNTIME_REL="phases/p2-gsjso/runs/fusion_w1/20260726_fusion_w1_aprime/runtime_env"', WRAPPER)
