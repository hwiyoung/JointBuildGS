...
DRIVER_PATH = REPO / "phases/p2-gsjso/scripts/fusion_w1/fusion_w1_aprime_training_20260726.py"
...
class AprimeTrainingContractTests(unittest.TestCase):
    ...
    def build(self, arm: str, profile: str = "full", run: str = "r1") -> dict:
        return driver.build_training_config(
            ...
            run=run,
            profile=profile,
            out_dir=REPO / "phases/p2-gsjso/runs/fusion_w1/20260726_fusion_w1_aprime/_unit_out",
        )
    ...
    def test_completed_output_verifier_requires_positive_terms_and_actual_prune(self) -> None:
        scratch_parent = REPO / "phases/p2-gsjso/runs/fusion_w1/20260726_fusion_w1_aprime"
