...
SCRIPT = REPO / "phases/p2-gsjso/scripts/fusion_w1/fusion_w1_training_v1_20260725.py"
...
class FusionW1TrainingTests(unittest.TestCase):
    ...
    def test_locked_config_contains_required_recipe(self):
        ...
        self.assertEqual(
            ...
            {
                "root": "phases/p2-gsjso/runs/fusion_w1/20260724_fusion_w1/runtime_env",
                "variables": {
                    "HOME": "home",
        ...
        self.assertIn(
            "phases/p2-gsjso/runs/fusion_w1/20260724_fusion_w1/runtime_env/",
