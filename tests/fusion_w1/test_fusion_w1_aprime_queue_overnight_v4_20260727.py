...
SCRIPT = Path(__file__).resolve().parents[2] / "phases/p2-gsjso/scripts/fusion_w1/fusion_w1_aprime_queue_continuation_v3_20260727.py"
CONFIG = Path(__file__).resolve().parents[2] / "phases/p2-gsjso/configs/fusion_w1/fusion_w1_aprime_queue_overnight_v4_20260727.json"
WRAPPER = Path(__file__).resolve().parents[2] / "phases/p2-gsjso/scripts/fusion_w1/run_fusion_w1_aprime_queue_overnight_v4_20260727.sh"
BASE_WRAPPER = Path(__file__).resolve().parents[2] / "phases/p2-gsjso/scripts/fusion_w1/run_fusion_w1_aprime_queue_continuation_v3_20260727.sh"
