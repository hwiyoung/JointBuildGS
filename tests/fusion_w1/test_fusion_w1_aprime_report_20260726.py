...
MODULE_PATH = REPO / "phases/p2-gsjso/scripts/fusion_w1/fusion_w1_aprime_report_20260726.py"
...
class ContractTests(unittest.TestCase):
    ...
    def test_docker_wrapper_is_nonnetworked_and_nonroot(self) -> None:
        wrapper = (
            REPO / "phases/p2-gsjso/scripts/fusion_w1/run_fusion_w1_aprime_report_20260726.sh"
