...
CONFIG = REPO / "phases/p2-gsjso/configs/fusion_w1/fusion_w1_aprime_queue_overnight_v4_repair1_20260728.json"
LOCK_ROOT = REPO / "phases/p2-gsjso/runs/fusion_w1/20260726_fusion_w1_aprime/unattended_queue_overnight_v4_repair1"
...
WRAPPER = REPO / "phases/p2-gsjso/scripts/fusion_w1/run_fusion_w1_aprime_queue_overnight_v4_repair1_20260728.sh"
V4_ROOT = REPO / "phases/p2-gsjso/runs/fusion_w1/20260726_fusion_w1_aprime/unattended_queue_overnight_v4"
...
class OvernightV4Repair1Test(unittest.TestCase):
    ...
    def test_single_level_extends_supported_schema(self) -> None:
        ...
        self.assertEqual(
            extends,
            {
                "path": "phases/p2-gsjso/configs/fusion_w1/fusion_w1_aprime_queue_continuation_v3_20260727.json",
    ...
    def test_new_namespace_only(self) -> None:
        ...
        self.assertEqual(
            repair_root,
            "phases/p2-gsjso/runs/fusion_w1/20260726_fusion_w1_aprime/unattended_queue_overnight_v4_repair1",
        )
