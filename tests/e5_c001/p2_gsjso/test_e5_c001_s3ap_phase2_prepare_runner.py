...
prepare = load_module("s3ap_phase2_prepare", REPO / "phases/p2-gsjso/scripts/e5_c001/e5_c001_s3ap_phase2_prepare.py")
runner = load_module("s3ap_phase2_runner", REPO / "phases/p2-gsjso/scripts/e5_c001/e5_c001_s3ap_phase2_runner.py")
...
class Phase2PrepareRunnerTest(unittest.TestCase):
    ...
    def test_tilt_requires_machine_trigger_and_uses_footprint_pca(self):
        self.assertEqual(
            ...
            "phases/p2-gsjso/runs/e5_c001/20260715_e5_c001_s3ap_phase2_prepare/return_signal.json",
        )
