...
def update_config(zeta_hat: float, ci_half: float) -> None:
    ...
    cfg["a1_zeta_ls"] = {
        ...
        "updated_by": "scripts/input_and_alignment/p2_gsjso/projection_zeta_ls.py --update-config",
    }
...
def write_versions(zeta0: float) -> None:
    ...
    text = "\n".join(
        [
            f"run_id: {RUN_ID}",
            f"git_head: {git_head()}",
            "command: python3 scripts/input_and_alignment/p2_gsjso/projection_zeta_ls.py --zeta0 48.0 --update-config",
