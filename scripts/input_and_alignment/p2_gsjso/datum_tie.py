...
RAW_SCRIPT = ROOT / "scripts/input_and_alignment/p2_gsjso/tum_mob_raw_to_npz.py"
...
def parse_args() -> argparse.Namespace:
    ...
    args = p.parse_args()
    args.command_for_versions = ["python", "scripts/input_and_alignment/p2_gsjso/datum_tie.py"] + [
