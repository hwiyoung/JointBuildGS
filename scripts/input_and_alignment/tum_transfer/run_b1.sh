...
# Launch: setsid nohup bash scripts/input_and_alignment/tum_transfer/run_b1.sh > results/tum_transfer/mob/b1.log 2>&1 &
set -u
cd "$(dirname "$0")/../../.." || exit 1
