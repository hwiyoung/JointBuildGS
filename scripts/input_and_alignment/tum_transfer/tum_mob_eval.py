...
def main():
    ...
    A = ap.parse_args()
    prep_script = ("scripts/input_and_alignment/tum_transfer/_mob_prep_las_gssem.py" if A.classifier == "gssem"
                   else "scripts/input_and_alignment/tum_transfer/_mob_prep_las.py")
