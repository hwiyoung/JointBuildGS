...
from scripts.evidence_and_attributes.review_packages.evidence_cards_v2 import (  # noqa: E402
    DATA,
    GEOJSON,
    REPO,
    clip_near,
...
OUT_CSV = REPO / "docs/experiments/input-and-alignment/projection_datum/tables/projection_datum_unitcheck.csv"
OUT_MD = REPO / "docs/experiments/input-and-alignment/projection_datum/reports/projection_datum_fix.md"
...
IMPACT_ROWS = [
    ...
    ("scripts/evidence_and_attributes/review_packages/evidence_cards_v2.py", "card v2 LoD2/ALS/footprint projection, roof masks, view angle selection"),
    ("scripts/evidence_and_attributes/review_packages/evidence_cards.py", "legacy evidence card projection path"),
    ("scripts/input_and_alignment/datum_and_projection/projection_gate.py", "historical retracted gate imports evidence_cards_v2 projection functions"),
    ("scripts/input_and_alignment/datum_and_projection/projection_gate2.py", "wide-search projection gate imports evidence_cards_v2 projection functions"),
    ("scripts/evaluation/quality_score/gate_diag.py", "clean visual diagnostic imports evidence_cards_v2 projection functions"),
    ("scripts/evidence_and_attributes/population_analysis/population_aux_v3.py", "observation geometry projection plus camera-point vectors now use ellipsoidal point Z"),
    ("scripts/evidence_and_attributes/population_analysis/texture_anchor_check.py", "texture anchor crops use population_aux_v3.project"),
    ("scripts/evidence_and_attributes/population_analysis/add_lowtex_v4.py", "lowtex v4 uses texture_anchor_check/build_crop and population camera parsing"),
    ("scripts/input_and_alignment/datum_and_projection/ztest.py", "diagnostic keeps explicit geoid_m=0 pre-fix simulation for old-vs-fix figures"),
    ("scripts/input_and_alignment/datum_and_projection/zmultiview.py", "diagnostic keeps explicit geoid_m=0 pre-fix simulation for old-vs-fix figures"),
    ("scripts/input_and_alignment/datum_and_projection/zfix_visual.py", "inherits ztest.proj_dz pre-fix simulation"),
    ("scripts/input_and_alignment/datum_and_projection/zresolve.py", "inherits ztest.proj_dz pre-fix simulation"),
]
...
def write_versions() -> None:
    ...
    text = "\n".join(
        [
            f"run_id: {RUN_ID}",
            f"git_head: {git_head()}",
            "command: python3 scripts/input_and_alignment/datum_and_projection/projection_datum_unitcheck.py",
...
def write_report(rows: list[dict[str, object]]) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "- Root file `원격발주_투영fix·LS정합·재게이트·재계산체인_레시피감사_20260702.md` was not present in this checkout; this A0 follows `CLAUDE.md`, `docs/experiments/input-and-alignment/projection_datum/reports/projection_geoid_rootcause.md`, and the retracted `docs/evidence/archive/projection_gate/v1/reports/projection_gate.md` note.",
            "",
            "## 판정 필요 지점",
            "",
