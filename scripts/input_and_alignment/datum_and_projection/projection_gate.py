...
from scripts.evidence_and_attributes.review_packages.evidence_cards_v2 import (to_cam, clip_near, clip_frustum, distort, proj_ring, roof_mask,
...
def main():
    ...
    import shutil; shutil.copy(out, REPO/"docs/evidence/archive/projection_gate/v1/tables/projection_gate.csv")
    # summary
