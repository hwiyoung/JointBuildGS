...
RAW_SCRIPT = ROOT / "scripts/input_and_alignment/tum_transfer/tum_mob_raw_to_npz.py"
...
DOC = ROOT / "docs/experiments/input-and-alignment/datum_tie/reports/datum_tie.md"
CSV_OUT = ROOT / "docs/experiments/input-and-alignment/datum_tie/tables/datum_tie_patches.csv"
...
def write_doc(rows: list[PatchRow], summary: dict[str, Any], run_dir: Path) -> None:
    ...
    lines = [
        ...
        f"- LS ζ 참고: {summary['ls_zeta_m']:.3f} ± 0.429 m (`docs/experiments/input-and-alignment/projection_zeta_ls/reports/projection_zeta_ls.md`).",
    ...
    lines.extend(
        [
            ...
            f"| LS ζ 참고 | {summary['ls_zeta_m']:.3f} | `docs/experiments/input-and-alignment/projection_zeta_ls/reports/projection_zeta_ls.md`의 사진 대응 LS 참고값 |",
...
def parse_args() -> argparse.Namespace:
    ...
    args = p.parse_args()
    args.command_for_versions = ["python", "scripts/input_and_alignment/datum_and_projection/datum_tie.py"] + [
