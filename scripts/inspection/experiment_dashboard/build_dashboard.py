...
def _export_ksplat(ckpt: Path, out: Path, mode: str, max_count: int = 400_000) -> bool:
    """Export a ckpt to .ksplat via scripts/input_and_alignment/visualization_and_export/export_2dgs_ksplat.py.
    ...
    cmd = [
        "python", str(ROOT / "scripts/input_and_alignment/visualization_and_export/export_2dgs_ksplat.py"),
        "--ckpt", str(ckpt),
        "--out", str(out),
        "--color-mode", mode,
