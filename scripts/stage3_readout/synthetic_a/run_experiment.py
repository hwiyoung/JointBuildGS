...
try:
    ...
    # buildings.py was removed after 3D BAG migration; these are only needed for synthetic buildings
    create_all_buildings = None
    save_gt_buildings = None
    building_to_cityjson = None
