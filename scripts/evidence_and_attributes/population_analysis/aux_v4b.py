...
from scripts.input_and_alignment.datum_and_projection.datum_tie_overlay import (  # noqa: E402
    DELTA_ZETA,
    ZETA_LEFT,
    ZETA_RIGHT,
    crop_bbox,
...
from src.geospatial.projection_datum import as_ellipsoidal_points, describe_projection_config  # noqa: E402
...
def write_versions(lowtex_rows: list[dict[str, object]], manifest: list[dict[str, object]]) -> None:
    ...
    lines = [
        f"run_id: {RUN_ID}",
        f"git_head: {git_head()}",
        "command: python scripts/evidence_and_attributes/population_analysis/aux_v4b.py",
