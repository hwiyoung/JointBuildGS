...
Run (p0-tools): docker run --rm --user $(id -u):$(id -g) -v $PWD:/workspace/JointBuildGS -w /workspace/JointBuildGS \
                  jointbuildgs-p0-tools:t0 python3 scripts/evidence_and_attributes/population_analysis/complexity_metric.py
"""
...
from scripts.evidence_and_attributes.geometry_fidelity.overseg_faithfulness import face_support, z_levels, step_aware_levels, GEOID, MIN_ALS
