...
from scripts.evidence_and_attributes.population_analysis.population_aux_v3 import parse_cam_model, parse_cameras, gml_building, DATA, REPO
from scripts.evidence_and_attributes.population_analysis.texture_anchor_check import build_crop, lowtex, T11_THR

CSV = REPO / "docs/evidence/archive/population_aux/v3/tables/population_aux_v3.csv"
