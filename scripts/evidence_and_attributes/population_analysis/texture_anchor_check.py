...
from scripts.evidence_and_attributes.population_analysis.population_aux_v3 import (parse_cam_model, parse_cameras, project, gml_building,
                               IMAGE_DIR, DATA, REPO)
...
def main():
    ...
    v3 = {r["building_id"].replace("DEBY_LOD2_", ""): r for r in __import__("csv").DictReader(open(REPO/"docs/evidence/archive/population_aux/v3/tables/population_aux_v3.csv"))}
