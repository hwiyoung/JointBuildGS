...
from src.geospatial.projection_datum import (
...
CARDDIR = REPO / "docs/evidence/evidence_cards_v2"
...
def main():
    ...
    xw = list(csv.DictReader(open(REPO/"docs/evidence/archive/bucket_crosswalk/v1/tables/bucket_crosswalk.csv")))
