...
EVCARD_V3 = REPO_ROOT / "scripts/evidence_and_attributes/population_analysis/aux_v4b.py"
...
def write_versions(manifest: list[dict[str, object]], manual_missing: bool) -> None:
    ...
    lines = [
        f"run_id: {RUN_ID}",
        f"git_head: {git_head()}",
        "command: docker run --rm --user $(id -u):$(id -g) -v $PWD:/workspace/JointBuildGS -w /workspace/JointBuildGS jointbuildgs-p0-tools:t0 python3 scripts/evidence_and_attributes/review_packages/judgment_kit_v4.py",
