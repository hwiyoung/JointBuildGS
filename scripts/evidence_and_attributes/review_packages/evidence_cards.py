...
from src.geospatial.projection_datum import base_to_canonical_points
...
def main():
    ...
    uncls = [r["building_id"].replace("DEBY_LOD2_", "") for r in csv.DictReader(open(REPO/"docs/evidence/archive/bucket_crosswalk/v1/tables/bucket_crosswalk.csv")) if r["new_class"] == "미분류"]
