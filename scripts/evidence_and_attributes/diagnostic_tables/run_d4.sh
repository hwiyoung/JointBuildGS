...
# Spec/pre-registration: docs/research/preregistration/joint_optimization/P2_D4_사양서_사전등록_20260625.md. EPSG:25832. branch feature/p2-prior-full.
# PREREQ: depth/normal maps staged at data_geoidfix/stereo (prior_full_stereo.sh) — same as D.
# Launch: setsid nohup bash scripts/evidence_and_attributes/diagnostic_tables/run_d4.sh > results/tum_transfer/mob/d4.log 2>&1 &
set -u
cd "$(dirname "$0")/../../.." || exit 1
