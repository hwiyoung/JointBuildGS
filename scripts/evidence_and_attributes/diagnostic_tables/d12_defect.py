...
Run (p0-tools): docker run --rm --user $(id -u):$(id -g) -v $PWD:/workspace/JointBuildGS -w /workspace/JointBuildGS \
  jointbuildgs-p0-tools:t0 python3 scripts/evidence_and_attributes/diagnostic_tables/d12_defect.py --arms gs_d4_dense gs_b1_dense [--targets ...]
...
from scripts.evidence_and_attributes.geometry_fidelity.overseg_faithfulness import face_support, MIN_ALS, TOL
