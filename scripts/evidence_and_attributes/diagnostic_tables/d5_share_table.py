...
state) reported in docs/experiments/joint-optimization/w_d4/reports/W_D4_precheck.md §3 / P2_D4_사양서 §3. They reproduce the D4 spec's locked shares
...
# LOCKED D-run raw means (mean[20000-30000]); docs/experiments/joint-optimization/w_d4/reports/W_D4_precheck.md §3.
...
def main():
    ...
    out("Raw means = LOCKED D-run mean[20-30k] (docs/experiments/joint-optimization/w_d4/reports/W_D4_precheck.md §3). De-noise FIXED = D4 across all arms.\n")
