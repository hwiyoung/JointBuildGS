...
Run (p0-tools container, after run_b1.sh produced mob_eval/gs_b1_*):
  python3 scripts/evidence_and_attributes/geometry_fidelity/overseg_b1_faithfulness.py --arms gs_d4_dense gs_b1_dense
...
from scripts.evidence_and_attributes.geometry_fidelity.overseg_faithfulness import face_support, step_aware_levels, z_levels, TOL, MIN_ALS, GEOID
