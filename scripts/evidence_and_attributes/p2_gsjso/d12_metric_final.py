...
Run (p0-tools): python3 scripts/evidence_and_attributes/p2_gsjso/d12_metric_final.py [--targets-file F]
...
from d6_shape_audit import footprint_paths, read_cloud
from overseg_analysis import parse_solid_roof
from overseg_faithfulness import face_support, MIN_ALS
