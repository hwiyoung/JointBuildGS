...
def write_versions(path: Path, args, rows: list[dict[str, object]], gate: dict[str, object], fps: dict[str, tuple[str, str]]) -> None:
    ...
    lines = [
        ...
        'run_command: docker run --rm --user "$(id -u):$(id -g)" -v "$PWD":/workspace/JointBuildGS -w /workspace/JointBuildGS jointbuildgs-p0-tools:t0 python3 scripts/evidence_and_attributes/p2_gsjso/pointcloud_attributes_v1_2.py',
