...
from d6_shape_audit import footprint_paths, read_cloud, roof_envelope, gml_building, EVAL
from assembly_fidelity import fit_plane, ref_planes, aligned_rms, roofenv_rms, target_faces
