...
PACKET_REL="docs/handoffs/P2_W2C_UTARGET199_CONTRACT_RESULTS_RECOVERY_R1_v1.md"
ACCEPTED_REL="artifacts/manifests/handoffs/P2-W2C-UTARGET199-CONTRACT-RESULTS-RECOVERY-R1-v1/100-accepted.json"
...
docker run --rm --network none --entrypoint /opt/conda/bin/python \
  ...
  scripts/repository/validate_two_host_handoff.py "${ACCEPTED_REL}" --repo . \
    --artifact-root /artifacts/JointBuildGS --origin-ref origin/main --head-ref HEAD
