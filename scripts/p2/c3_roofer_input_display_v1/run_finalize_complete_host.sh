...
source_rel="${base}/P2-C3-12ROW-COMPARISON-DISPLAY-RECOVERY-v4"
input_rel="${base}/P2-C3-ROOFER-INPUT-DISPLAY-RECOVERY-v1"
diagnostic_rel="phase-payloads/p2/c3_tsdf_roof_diagnostic_v1/P2-C3-TSDF-ROOF-DIAGNOSTIC-RENDER-RECOVERY-v1"
output_rel="${base}/P2-C3-COMPLETE-LINEAGE-REPORT-RECOVERY-v1"
