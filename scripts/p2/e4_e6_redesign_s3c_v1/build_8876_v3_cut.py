...
Creates P2-E1-E6-VIEWER-REDESIGN-v2 next to the sealed v16 viewer: app files
...
S3 = ART / "phase-payloads/p2/e4_e6_redesign_s3c_v1/P2-E4-E6-REDESIGN-S3C-v1"
CUT = OX / "P2-E1-E6-VIEWER-REDESIGN-v2"
...
ARMS = {"E4": "E4_V3_TIN025", "E5": "E5_V3_F1_TIN025"}
...
def main() -> None:
    ...
    for b in manifest["buildings"]:
        ...
        for slot, arm in ARMS.items():
            ...
            spec.update({
                ...
                "lineage_label": "REDESIGN_V3_TIN025_R0P25",
                "metrics": None,
                "development_g3_g4": None,
                "automatic_candidate": None,
            })
            b.setdefault("conditions", {})[slot] = spec
    manifest["task_id"] = "P2-E1-E6-VIEWER-REDESIGN-v2"
    ...
    banner = ('<div style="background:#173a5e;color:#cfe4ff;padding:6px 12px;font:12px system-ui">'
              '재설계 컷: <b>E4/E5 슬롯 = 재설계 v3(TIN 0.25m) 산출</b> · E3/E6 = 레거시 · 점군 = roofer 입력(전량) · '
    ...
    relink(UMBRELLA / "redesign_v2", CUT)
    (UMBRELLA / "index.html").write_text(
        ...
        '<li><a href="redesign_v2/">redesign_v2</a> — <b>E4/E5 슬롯 = 재설계 v3(TIN 0.25m)</b>, 점군 = roofer 입력 전량</li>'
        '<li><a href="redesign_v1/">redesign_v1</a> — E4/E5 슬롯 = 재설계 v2(TIN 0.5m)</li>'
