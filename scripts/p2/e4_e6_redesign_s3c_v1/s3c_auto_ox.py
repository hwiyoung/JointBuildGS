...
S3_ROOT = ARTIFACTS / "phase-payloads/p2/e4_e6_redesign_s3c_v1/P2-E4-E6-REDESIGN-S3C-v1"
V22_CONFIG = REPO / "configs/p2/e1_e6_roofer_ox_review_v1/reference_auto_ox_v1.json"
NEW_CONDITIONS = ("E4_V3_TIN025", "E5_V3_F1_TIN025")
...
def main() -> None:
    ...
    csv_path = out_root / "s3c_building_condition_v1.csv"
    with csv_path.open("w", newline="", encoding="utf-8") as handle:
        writer = csv.DictWriter(handle, fieldnames=list(rows[0].keys()))
        writer.writeheader()
        writer.writerows(rows)
    summary = {
        "schema": "jointbuildgs.p2.e4_e6_redesign_s3c_v1.auto_ox.v1",
        "task_id": "P2-E4-E6-REDESIGN-S3C-v1",
        "started_utc": started,
    ...
    (out_root / "s3c_auto_ox_summary_v1.json").write_text(json.dumps(summary, indent=2, sort_keys=True) + "\n", encoding="utf-8")
    brief = {
        "O50": {
