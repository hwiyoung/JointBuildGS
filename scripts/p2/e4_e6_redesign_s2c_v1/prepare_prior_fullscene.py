...
from scripts.p2.e4_e6_redesign_s1_v1.prepare_prior_v2 import load_scene_als
from scripts.p2.e4_e6_redesign_s2c_v1.tin025 import dsm_tin
...
def main() -> None:
    ...
    receipt_path = out_root / "control/200-s2c-prior-preflight-passed.json"
    ...
    receipt = {
        "schema": "jointbuildgs.p2.e4_e6_redesign_s2c_v1.prior_preflight.v1",
    ...
    target_path = receipt_path if passed else out_root / "control/100-s2c-prior-preflight-failed.json"
