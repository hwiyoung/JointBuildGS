...
CONFIG_PATH = REPO / "phases/p2-gsjso/configs/boundary_and_robustness/primary4_assembly_validation_v2.json"
QA_SCRIPT = REPO / "scripts/boundary_and_robustness/assembly_validation/primary4_assembly_validation_qa.py"
DOCS = REPO / "docs"
...
def finalize() -> None:
    ...
    source_paths = {
        ...
        *sorted((REPO / cfg["source_paths"]["lod2_dir"]).glob("*.gml")),
        REPO / "phases/p2-gsjso/runs/quality_score/20260716_genclose_flat_density/cityjson/flat_density_g0500.city.json",
    }
    output_paths = {
        MEASUREMENTS,
        SUMMARY,
    ...
    manifest = {
        ...
        "orchestration_logs_excluded_from_payload_hash_scope": [
            "phases/p2-gsjso/runs/boundary_and_robustness/20260721_primary4_assembly_validation_driver"
        ],
        "source_sha256": {
