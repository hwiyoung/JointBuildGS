...
SCRIPT="scripts/boundary_and_robustness/p2_gsjso/primary4_assembly_validation.py"
QA_SCRIPT="scripts/boundary_and_robustness/p2_gsjso/primary4_assembly_validation_qa.py"
