...
V2_METRICS = REPO / "docs/evidence/archive/boundary_map/v2/tables/boundary_map_v2_metrics.csv"
V2_MAST3R_SCRIPT = SCRIPT_DIR / "boundary_map_v2_mast3r.py"
P0_AUX_SCRIPT = REPO / "scripts/evidence_and_attributes/population_analysis/population_aux_v3.py"
P0_DATUM_SCRIPT = REPO / "src/geospatial/projection_datum.py"
P0_PROJECTION_CONFIG = REPO / "configs/input_and_alignment/projection_datum.json"
RETRI_SCRIPT = REPO / "scripts/e5_c001/e5_c001_s3ap_fm_retriangulation.py"
RESCORE_SCRIPT = REPO / "scripts/e5_c001/e5_c001_s3ap_fm_retri_rescore.py"
BASE_SCRIPT = REPO / "scripts/e5_c001/e5_c001_s3ap_fm_rescore.py"
