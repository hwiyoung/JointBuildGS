...
V3_SCRIPT="scripts/boundary_and_robustness/boundary_map/boundary_map_v3.py"
V3_DENSE_SCRIPT="scripts/boundary_and_robustness/boundary_map/boundary_map_v3_dense.py"
DRIVER_SCRIPT="scripts/boundary_and_robustness/boundary_map/run_boundary_map_v3_20260719.sh"
UID_GID="$(id -u):$(id -g)"
START_EPOCH="$(date +%s)"
...
expected_sources = {
    ...
    "scripts/boundary_and_robustness/boundary_map/boundary_map_v3.py",
