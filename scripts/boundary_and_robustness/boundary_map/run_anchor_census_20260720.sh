...
SCRIPT="scripts/boundary_and_robustness/boundary_map/anchor_census.py"
DENSE_SCRIPT="scripts/boundary_and_robustness/boundary_map/anchor_census_dense.py"
...
run_finalize() {
  ...
  if ! run_dev python3 "$SCRIPT" finalize \
    ...
    commit_stage \
      ...
      docs/experiments/input-and-alignment/boundary_map/reports/W_anchor_census_boundary_map_v4_summary_20260720.md \
