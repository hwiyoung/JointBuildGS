...
RUN_REL="phases/p2-gsjso/runs/boundary_and_robustness/20260721_degradation_curve"
RUN="$REPO/$RUN_REL"
RUNTIME="$RUN/runtime"
DRIVER_REL="phases/p2-gsjso/runs/boundary_and_robustness/20260721_degradation_curve_driver"
...
RECOVERY_SCRIPT="scripts/boundary_and_robustness/degradation_curve/degradation_curve_v3_recovery.py"
...
preflight() {
  ...
  run_tools python3 scripts/boundary_and_robustness/degradation_curve/degradation_curve_v3.py \
...
finalize_noise() {
  ...
  run_tools python3 scripts/boundary_and_robustness/degradation_curve/degradation_curve_v3_qa.py \
    --scope noise > "$LOG_DIR/noise_qa.log" 2>&1
  issue "DC-NOISE partial complete: stages=6/12; rows=1068/2136; measurements_sha256=$(sha docs/experiments/evaluation/degradation_curve/tables/degradation_curve_measurements.csv); summary_sha256=$(sha docs/experiments/evaluation/degradation_curve/tables/degradation_curve_summary.csv); manifest_sha256=$(sha docs/experiments/evaluation/degradation_curve/manifests/degradation_curve_manifest.json); noise_figure_sha256=$(sha docs/figs/degradation_curve/degradation_curve_noise.png); learning_runs_started=0; new_inference_runs=0"
  commit_paths \
    "DC-NOISE: measure canonical noise axis" \
    phases/p2-gsjso/docs/issues.md \
    docs/experiments/evaluation/degradation_curve/tables/degradation_curve_measurements.csv \
    docs/experiments/evaluation/degradation_curve/tables/degradation_curve_summary.csv \
    docs/experiments/evaluation/degradation_curve/manifests/degradation_curve_manifest.json \
    docs/experiments/evaluation/degradation_curve/reports/W_degradation_curve_summary_20260721.md \
...
finalize_ledger() {
  CURRENT_WAVE="ledger"
  issue "DC-LEDGER commits: prep=$PREP_COMMIT; noise=$NOISE_COMMIT; full=$FINAL_COMMIT; manifest_sha256=$(sha docs/experiments/evaluation/degradation_curve/manifests/degradation_curve_manifest.json); issues_sha256_before_ledger_commit=$(sha phases/p2-gsjso/docs/issues.md)"
  commit_paths \
