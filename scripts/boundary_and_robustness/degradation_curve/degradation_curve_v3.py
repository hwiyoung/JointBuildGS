...
DRIVER_SCRIPT = (
    REPO / "scripts/boundary_and_robustness/degradation_curve/run_degradation_curve_20260721.sh"
)
RECOVERY_SCRIPT = (
    REPO / "scripts/boundary_and_robustness/degradation_curve/degradation_curve_v3_recovery.py"
)
