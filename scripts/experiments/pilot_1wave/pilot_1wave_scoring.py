...
CHEAP_REFINE_SCORES = REPO / "docs/experiments/qs_cheap_refine_sweep/tables/qs_cheap_refine_sweep.csv"
...
def validate_roofer_pointcloud_in_tools(path: Path) -> dict[str, Any]:
    ...
    command = [
        ...
        P0_TOOLS_IMAGE,
        "python3",
        str(container_repo / "scripts/experiments/pilot_1wave/pilot_1wave_scoring.py"),
        "validate-pointcloud",
        "--pointcloud",
