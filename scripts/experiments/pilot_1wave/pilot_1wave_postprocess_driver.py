...
CLASSIFIER = REPO / "scripts/experiments/pilot_1wave/pilot_1wave_scene_classify.py"
SCORING = REPO / "scripts/experiments/pilot_1wave/pilot_1wave_scoring.py"
LOSS_AGGREGATE = REPO / "scripts/experiments/pilot_1wave/pilot_1wave_loss_cursor_aggregate.py"
BINDING_AUDIT = REPO / "scripts/experiments/pilot_1wave/pilot_1wave_binding_audit.py"
...
REQUIRED_COMMITTED_PATHS = (
    ...
    Path("scripts/experiments/pilot_1wave/pilot_1wave_postprocess_driver.py"),
    Path("phases/p2-gsjso/scripts/e5_c001_readout_extract_ablation.py"),
    Path("scripts/experiments/pilot_1wave/pilot_1wave_readout_lineage.py"),
    Path("scripts/experiments/pilot_1wave/pilot_1wave_scene_classify.py"),
    Path("scripts/experiments/pilot_1wave/pilot_1wave_scoring.py"),
    Path("scripts/experiments/pilot_1wave/pilot_1wave_loss_cursor_aggregate.py"),
    Path("scripts/experiments/pilot_1wave/pilot_1wave_binding_audit.py"),
)
