...
MEASUREMENTS_CSV = DOCS / "experiments/degradation_curve/tables/degradation_curve_measurements.csv"
SUMMARY_CSV = DOCS / "experiments/degradation_curve/tables/degradation_curve_summary.csv"
MANIFEST_JSON = DOCS / "experiments/degradation_curve/manifests/degradation_curve_manifest.json"
...
QA_SCRIPT = REPO / "scripts/experiments/degradation_curve/degradation_curve_v3_qa.py"
DRIVER_SCRIPT = (
    REPO / "scripts/experiments/degradation_curve/run_degradation_curve_20260721.sh"
)
RECOVERY_SCRIPT = (
    REPO / "scripts/experiments/degradation_curve/degradation_curve_v3_recovery.py"
)
