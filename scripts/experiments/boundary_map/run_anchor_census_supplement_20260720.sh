...
DOC_PAIRS="docs/experiments/boundary_map/tables/anchor_census_supplement_pairs.csv"
DOC_MEASUREMENTS="docs/experiments/boundary_map/tables/anchor_census_supplement_measurements.csv"
DOC_RELIABILITY="docs/experiments/boundary_map/tables/anchor_census_supplement_same_block_reliability_pairs.csv"
LADDER="docs/experiments/boundary_map/tables/boundary_map_v4_1_ladder.csv"
PUBLIC_MANIFEST="docs/experiments/boundary_map/manifests/anchor_census_supplement_manifest.json"
SUMMARY="docs/experiments/boundary_map/reports/W_anchor_census_supplement_boundary_map_v4_1_summary_20260720.md"
