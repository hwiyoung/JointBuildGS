        ...
        for name in selected_run_names(args):
            ...
            if paths["npz"].exists() and paths["coverage"].exists() and not args.force:
                ...
                cmd = dev_docker_base(args) + [
                    "python",
                    "scripts/e5_c001/e5_c001_readout_extract_ablation.py",
                    "--ckpt",
                    rel(ckpt),
                    "--out",
                    rel(paths["npz"]),
    ...
    for setting in settings:
        ...
        for name in names:
            ...
            for bid in C001_IDS:
                ...
                prep_cmd = TOOLS_RUN + [
                    "python3",
                    "scripts/input_and_alignment/tum_transfer/_mob_prep_las_gssem.py",
                    "--tsdf",
...
def write_versions(settings: list[Setting], inventory: list[dict[str, Any]], figures: list[Path]) -> None:
    ...
    lines = [
        ...
        f"extractor_script: scripts/e5_c001/e5_c001_readout_extract_ablation.py",
...
def evaluate_or_container(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        cmd = [
            ...
            "python3",
            "scripts/e5_c001/e5_c001_readout_ablation.py",
            "evaluate",
        ]
        if args.settings:
            cmd.append("--settings")
