...
CONFIG_DIR = REPO / "configs/e5_c001/e5_s2p_interaction"
...
BASE_CONFIG = REPO / "configs/e5_c001/e5_s2_direction_position/gs_e5_C001_s2_arm1_dense_r1.yaml"
...
def _evaluation_container(args: argparse.Namespace) -> None:
    ...
    cmd = [
        ...
        "python3",
        "scripts/e5_c001/e5_c001_s2p_interaction.py",
        "evaluate",
    ]
    if args.force:
        cmd.append("--force")
...
def _s0_dense_count() -> int:
    source = REPO / "phases/p2-gsjso/runs/e5_c001/e5p_train_20260707_C001/train_fingerprints.csv"
    for row in read_csv(source):
