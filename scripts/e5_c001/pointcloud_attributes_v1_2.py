...
def date_material(repo: Path, args) -> dict[str, str]:
    ...
    return {
        ...
        "als_source": "docs/evidence/p0-audit/w1-input-diagnostics/reports/data_inventory.md",
...
def source_fingerprints(repo: Path, args) -> dict[str, tuple[str, str]]:
    paths = {
        ...
        "w1_diagnosis": repo / "docs/evidence/p0-audit/w1-input-diagnostics/reports/W1_diagnosis.md",
        ...
        "data_inventory": repo / "docs/evidence/p0-audit/w1-input-diagnostics/reports/data_inventory.md",
    }
...
def write_versions(path: Path, args, rows: list[dict[str, object]], gate: dict[str, object], fps: dict[str, tuple[str, str]]) -> None:
    ...
    lines = [
        ...
        'run_command: docker run --rm --user "$(id -u):$(id -g)" -v "$PWD":/workspace/JointBuildGS -w /workspace/JointBuildGS jointbuildgs-p0-tools:t0 python3 scripts/e5_c001/pointcloud_attributes_v1_2.py',
    ...
    lines += [
        ...
        "",
        "outputs:",
        "  docs/evidence/archive/pointcloud_attributes/v1_2/tables/pointcloud_attributes_v1_2.csv",
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--v1-1-csv", default="docs/evidence/archive/pointcloud_attributes/v1_1/tables/pointcloud_attributes_v1_1.csv")
    ap.add_argument("--out-csv", default="docs/evidence/archive/pointcloud_attributes/v1_2/tables/pointcloud_attributes_v1_2.csv")
