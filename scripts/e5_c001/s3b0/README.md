...
Tests live in `tests/e5_c001/s3b0/`. Dependencies whose exact phase path is locked by adjacent S3A′ or historical workflows remain in `phases/p2-gsjso/scripts/`.
