...
def run_v1(args: argparse.Namespace) -> None:
    ...
    generation_sources: set[Path] = {
        ...
        common.REPO / "scripts/e5_c001/s3b0/run_e5_c001_s3b0_seed_v1.sh",
        common.REPO / "tests/e5_c001/s3b0/test_e5_c001_s3b0_seed.py",
...
def run_v2(args: argparse.Namespace) -> None:
    ...
    generation_sources: set[Path] = {
        ...
        Path(__file__).resolve(),
        Path(common.__file__).resolve(),
        common.REPO / "scripts/e5_c001/s3b0/run_e5_c001_s3b0_seed_v2.sh",
        common.REPO / "tests/e5_c001/s3b0/test_e5_c001_s3b0_seed.py",
        common.REPO / "src/stage2/semantic_seed.py",
        anchor_path,
