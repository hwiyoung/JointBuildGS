...
REPORT_PATH = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/reports/W_E5_C001_corrected_S1.md"
TEMP_READOUT_REPORT = REPO / "docs/evidence/archive/e5_c001_corrected_s1/temporary/reports/W_E5_C001_corrected_S1_readout_tmp.md"
...
def configure() -> None:
    ...
    s1.ab.COVERAGE_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/tables/e5_c001_corrected_s1_coverage.csv"
    s1.ab.FILTER_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/tables/e5_c001_corrected_s1_filter_contrib.csv"
    s1.ab.METRICS_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/tables/e5_c001_corrected_s1_building_8way.csv"
    s1.ab.SUMMARY_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/tables/e5_c001_corrected_s1_summary.csv"
    s1.ab.TRADEOFF_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/tables/e5_c001_corrected_s1_tradeoff.csv"
    s1.ab.CASE_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/tables/e5_c001_corrected_s1_representative_buildings.csv"
    s1.ab.INVENTORY_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/tables/e5_c001_corrected_s1_inventory.csv"
    s1.ab.ISSUES_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1/tables/e5_c001_corrected_s1_issues.csv"
...
def train_fingerprints() -> None:
    ...
    for run_name in RUN_NAMES:
        ...
        cfg = REPO / "configs/e5_c001/e5_corrected_s1" / f"{run_name}.yaml"
...
def evaluate_or_container(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        cmd = [
            ...
            "python3",
            "scripts/e5_c001/e5_c001_corrected_s1.py",
            "evaluate",
        ]
        if args.settings:
            cmd.append("--settings")
