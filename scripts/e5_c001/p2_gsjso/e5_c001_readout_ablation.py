...
TRAIN_RUN_DIR = REPO / "phases/p2-gsjso/runs/e5_c001/e5p_train_20260707_C001"
...
REPORT_PATH = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/reports/W_E5_C001_③a_readout재실행.md"
COVERAGE_CSV = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_coverage.csv"
FILTER_CSV = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_filter_contrib.csv"
METRICS_CSV = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_metrics.csv"
SUMMARY_CSV = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_summary.csv"
TRADEOFF_CSV = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_tradeoff.csv"
CASE_CSV = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_representative_buildings.csv"
INVENTORY_CSV = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_inventory.csv"
ISSUES_CSV = REPO / "docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_issues.csv"
BASELINE_METRICS = REPO / "docs/experiments/evaluation/e5_c001_8way/tables/e5_c001_8way_metrics.csv"
RENDER_COVERAGE = REPO / "docs/experiments/evaluation/e5_c001_render/tables/e5_c001_render_readout_coverage.csv"
        ...
        for name in selected_run_names(args):
            ...
            if paths["npz"].exists() and paths["coverage"].exists() and not args.force:
                ...
                cmd = dev_docker_base(args) + [
                    "python",
                    "scripts/e5_c001/p2_gsjso/e5_c001_readout_extract_ablation.py",
                    "--ckpt",
                    rel(ckpt),
                    "--out",
                    rel(paths["npz"]),
    ...
    for setting in settings:
        ...
        for name in names:
            ...
            for bid in C001_IDS:
                ...
                prep_cmd = TOOLS_RUN + [
                    "python3",
                    "scripts/input_and_alignment/p2_gsjso/_mob_prep_las_gssem.py",
                    "--tsdf",
...
def write_report(
    ...
    lines = [
        ...
        f"- 정본 조립 입력/기준선: `{rel(CANON_GATE_DIR)}`와 `docs/experiments/evaluation/e5_c001_8way/tables/e5_c001_8way_metrics.csv`.",
        f"- ② readout 귀속 근거: `docs/experiments/evaluation/e5_c001_render/reports/W_E5_C001_렌더플로터점검.md`, `docs/experiments/evaluation/e5_c001_render/tables/e5_c001_render_readout_coverage.csv`.",
        ...
        *md_table(
        ...
        "## 대표 건물",
        "",
        "- 60098과 8568391은 ②에서 readout 폐기가 큰 사례로 지정된 두 동이다. 전체 행은 `docs/experiments/citygml-readout/e5_c001_readout_ablation/tables/e5_c001_readout_ablation_representative_buildings.csv`에 둔다.",
        "",
        *md_table(
        ...
        *[f"- `{rel(path)}`" for path in figures],
        ...
        "## 인용",
        "",
        "- ② 회신: `docs/experiments/evaluation/e5_c001_render/reports/W_E5_C001_렌더플로터점검.md`.",
        "- 분석 연결: `docs/W_E5_C001_렌더플로터_분석·③라우팅_20260707.md`(파일이 있으면 잠금본 우선).",
        "- config 감사: `docs/experiments/joint-optimization/w_d4/reports/W_D4_손실config_감사.md` §6.",
...
def write_versions(settings: list[Setting], inventory: list[dict[str, Any]], figures: list[Path]) -> None:
    ...
    lines = [
        ...
        f"extractor_script: scripts/e5_c001/p2_gsjso/e5_c001_readout_extract_ablation.py",
...
def evaluate_or_container(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        cmd = [
            ...
            "python3",
            "scripts/e5_c001/p2_gsjso/e5_c001_readout_ablation.py",
            "evaluate",
        ]
        if args.settings:
            cmd.append("--settings")
