...
def write_versions(path: Path, args: argparse.Namespace, check: dict[str, object], new_rows: list[dict[str, object]]) -> None:
    ...
    lines = [
        ...
        'run_command: docker run --rm --user "$(id -u):$(id -g)" -v "$PWD":/workspace/JointBuildGS -w /workspace/JointBuildGS jointbuildgs-p0-tools:t0 python3 scripts/e5_c001/p2_gsjso/e5_pointcloud_attributes_v1_3.py',
