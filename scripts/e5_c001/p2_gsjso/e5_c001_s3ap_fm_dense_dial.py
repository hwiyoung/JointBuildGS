...
CONFIG = REPO / "phases/p2-gsjso/configs/e5_c001/e5_c001_s3ap_fm_dense_dial.json"
RUN_DIR = REPO / "phases/p2-gsjso/runs/e5_c001/20260715_e5_c001_s3ap_phase0_fm_dense"
...
OUT_CSV = REPO / "docs/experiments/input-and-alignment/e5_c001_s3ap/tables/e5_c001_s3ap_fm_dense_dial.csv"
FIGURE = REPO / "docs/figs/e5_c001_s3ap_phase0/fm_dense_curve.png"
OLD_RUN = REPO / "phases/p2-gsjso/runs/e5_c001/20260714_e5_c001_s3ap_fm_retriangulation"
...
retri = load_module(
    ...
    REPO / "scripts/e5_c001/p2_gsjso/e5_c001_s3ap_fm_retriangulation.py",
)
rescore = load_module(
    "s3ap_fm_retri_rescore_dense_dial",
    REPO / "scripts/e5_c001/p2_gsjso/e5_c001_s3ap_fm_retri_rescore.py",
)
base = retri.base
...
def main() -> None:
    ...
    source_paths = [
        ...
        REPO / "scripts/e5_c001/p2_gsjso/e5_c001_s3ap_fm_retriangulation.py",
        REPO / "scripts/e5_c001/p2_gsjso/e5_c001_s3ap_fm_rescore.py",
        REPO / "scripts/e5_c001/p2_gsjso/e5_c001_s3ap_fm_retri_rescore.py",
