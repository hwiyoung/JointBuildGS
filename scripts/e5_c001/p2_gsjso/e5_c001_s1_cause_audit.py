...
S1_TRAIN_RUN = REPO / "phases/p2-gsjso/runs/e5_c001/20260708_e5_c001_3b_s1"
...
def event_stats(args: argparse.Namespace) -> None:
    ...
    s0_fps = {r["run_name"]: r for r in read_csv(REPO / "phases/p2-gsjso/runs/e5_c001/e5p_train_20260707_C001/train_fingerprints.csv")}
    tags_to_pull = [
        "loss/total",
        "loss/photo",
        "loss/depth",
...
def write_versions() -> None:
    lines = [
        ...
        f"script=scripts/e5_c001/p2_gsjso/e5_c001_s1_cause_audit.py",
    ]
