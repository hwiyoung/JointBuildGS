...
def write_report(args: argparse.Namespace) -> None:
    ...
    write_csv(Path("docs/experiments/pilots/e5_pilot/tables/e5_pilot_seed_pair_status.csv"), seed_rows)
    write_csv(Path("docs/experiments/pilots/e5_pilot/tables/e5_pilot_seed_pair_summary.csv"), summary_rows)
    ...
    write_csv(Path("docs/experiments/pilots/e5_pilot/tables/e5_pilot_completion_checklist.csv"), checklist)
    ...
    lines = [
        ...
        *md_table(summary_rows, ["씨앗", "짝 기준", "기준 has_lod22", "GS r1 has_lod22", "GS r2 has_lod22", "r1-r2 flip", "r1 유효성 통과", "r2 유효성 통과"]),
        ...
        "- 속성 검산: `docs/experiments/input-and-alignment/pointcloud_attributes/tables/e5_pilot_pointcloud_attributes_v1_3_check.json`.",
        "",
        "## 관찰",
        "",
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--train-run-dir", default="phases/p2-gsjso/runs/e5_c001/e5p_train_20260707_C001")
    ...
    parser.add_argument("--report", default="docs/experiments/pilots/e5_pilot/reports/W_E5_pilot_gate.md")
    return parser
