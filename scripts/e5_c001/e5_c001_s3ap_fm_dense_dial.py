...
retri = load_module(
    ...
    REPO / "scripts/e5_c001/e5_c001_s3ap_fm_retriangulation.py",
)
rescore = load_module(
    "s3ap_fm_retri_rescore_dense_dial",
    REPO / "scripts/e5_c001/e5_c001_s3ap_fm_retri_rescore.py",
)
base = retri.base
...
def main() -> None:
    ...
    source_paths = [
        ...
        REPO / "scripts/e5_c001/e5_c001_s3ap_fm_retriangulation.py",
        REPO / "scripts/e5_c001/e5_c001_s3ap_fm_rescore.py",
        REPO / "scripts/e5_c001/e5_c001_s3ap_fm_retri_rescore.py",
