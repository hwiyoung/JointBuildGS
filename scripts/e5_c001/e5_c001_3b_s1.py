...
TEMP_READOUT_REPORT = REPO / "docs/evidence/archive/e5_c001_3b_s1/temporary/reports/W_E5_C001_3b_S1_readout_tmp.md"
...
def write_train_fingerprints() -> None:
    ...
    for run_name in S1_RUN_NAMES:
        ...
        cfg = REPO / "configs/e5_c001/e5_3b_s1" / f"{run_name}.yaml"
...
def evaluate_or_container(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        cmd = [
            ...
            "python3",
            "scripts/e5_c001/e5_c001_3b_s1.py",
            "evaluate",
        ]
        if args.settings:
            cmd.append("--settings")
