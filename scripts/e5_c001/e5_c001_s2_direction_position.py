...
CONFIG_DIR = REPO / "configs/e5_c001/e5_s2_direction_position"
...
CHECKPOINT_REPORT = REPO / "docs/evidence/archive/e5_c001_s2/temporary/reports/W_E5_C001_S2_checkpoint_20260710.md"
...
def infer_priors(args: argparse.Namespace) -> None:
    ...
    cmd = docker_base(args.gpu, {"E5_S2_PRIOR_CONTAINER": "1", "MPLCONFIGDIR": "/tmp/matplotlib"}) + [
        "python",
        "scripts/e5_c001/e5_c001_s2_direction_position.py",
        "infer-priors",
        "--device",
        "cuda:0",
    ]
...
def implementation_check(_args: argparse.Namespace) -> None:
    ...
    rows = [
        ...
        },
        {
            ...
            "source": "scripts/e5_c001/e5_c001_readout_extract_ablation.py; e5_c001_pipeline_strips.py",
        },
    ]
