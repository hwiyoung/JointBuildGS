...
def build_lenses() -> dict[str, dict[str, str]]:
    ...
    if Path("docs/experiments/evaluation/attr_outcome_regression/tables/regression_input_snapshot.csv").exists():
        for row in read_csv(Path("docs/experiments/evaluation/attr_outcome_regression/tables/regression_input_snapshot.csv")):
...
def write_report(
    ...
    lines = [
        ...
        *md_table(
        ...
        "## 층화 렌즈",
        "",
        "- 복잡도·크기·관측 렌즈는 `docs/experiments/evaluation/attr_outcome_regression/tables/regression_input_snapshot.csv`의 C001 행을 재사용했다.",
