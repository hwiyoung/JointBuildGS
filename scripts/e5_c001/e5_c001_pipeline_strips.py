...
CSV_STRIPS = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_pipeline_strips.csv"
CSV_ISSUES = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_pipeline_strips_issues.csv"
...
def initial_conditions() -> list[StripCondition]:
    return [
        StripCondition(
            ...
            REPO / "docs/experiments/joint-optimization/e5_c001_3b_s1/tables/e5_c001_3b_s1_coverage.csv",
            REPO / "docs/experiments/joint-optimization/e5_c001_3b_s1/tables/e5_c001_3b_s1_metrics.csv",
        ...
        StripCondition(
            ...
            REPO / "docs/experiments/joint-optimization/e5_c001_corrected_s1_recheck/tables/e5_c001_corrected_s1_recheck_preprune_coverage.csv",
...
def factor_conditions(weight: int | None) -> list[StripCondition]:
    ...
    return [
        StripCondition(
            ...
            REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_coverage.csv",
            REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_building_8way.csv",
            factor.P0_RUN_ID,
        )
        for cell in cells
    ]
