...
CONFIG_DIR = REPO / "configs/e5_c001/e5_s1_full_factor"
...
TEMP_READOUT_REPORT = REPO / "docs/evidence/archive/e5_c001_s1_full/temporary/reports/W_E5_C001_S1_full_factor_readout_tmp.md"
...
CSV_GRAD_SHARE = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_grad_share.csv"
CSV_TIMELINE = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_timeline_roofcrop.csv"
CSV_SHEET = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_sheet_identity.csv"
CSV_FACTOR = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_factor_cells.csv"
CSV_DEPTH_SOURCE = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_depth_source.csv"
CSV_INVENTORY = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_inventory.csv"
CSV_ISSUES = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_issues.csv"
CSV_405_REPAIR = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_405_rescore.csv"
CSV_NORMAL_PRECHECK = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_normal_precheck.csv"
CSV_PIPELINE_STRIPS = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_pipeline_strips.csv"
...
def configure_ablation_module(weight: int | None = None) -> list[Cell]:
    ...
    ab.COVERAGE_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_coverage.csv"
    ab.FILTER_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_filter_contrib.csv"
    ab.METRICS_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_building_8way.csv"
    ab.SUMMARY_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_summary.csv"
    ab.TRADEOFF_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_tradeoff.csv"
    ab.CASE_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_representative_buildings.csv"
    ab.INVENTORY_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_readout_inventory.csv"
    ab.ISSUES_CSV = REPO / "docs/experiments/joint-optimization/e5_c001_s1_full/tables/e5_c001_s1_full_readout_issues.csv"
...
def evaluate_or_container(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        cmd = [
            ...
            "python3",
            "scripts/e5_c001/e5_c001_s1_full_factor.py",
            "evaluate",
            "--weight",
...
def depth_source(_args: argparse.Namespace) -> None:
    rows = []
    config_paths = sorted((REPO / "configs/e5_c001/e5_corrected_s1_recheck").glob("gs_e5_C001_corrected_s1_preprune_*_r1.yaml"))
