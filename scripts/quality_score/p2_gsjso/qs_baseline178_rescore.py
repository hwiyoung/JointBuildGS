...
``assembled=true`` in ``docs/regression_input_snapshot.csv``.  Dense(w2_1),
...
A_SCORE_SCRIPT = REPO / "scripts/quality_score/p2_gsjso/overnight_qs_rescore.py"
...
def write_manifest(
    ...
    payload = {
        ...
        "population_definition": (
            "docs/regression_input_snapshot.csv raw_lidar assembled=true"
        ),
