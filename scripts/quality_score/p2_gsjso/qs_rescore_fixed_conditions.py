...
DOCS = REPO / "docs"
RUN_DIR = REPO / "phases/p2-gsjso/runs/quality_score/20260717_qs_rescore_fixed_conditions"
SCORES = DOCS / "qs_rescore_scores.csv"
PAIRS = DOCS / "qs_rescore_pairs.csv"
SOURCE_MANIFEST = REPO / "phases/p2-gsjso/runs/quality_score/20260716_qs_rescore/manifest.json"
