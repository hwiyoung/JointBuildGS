...
Run from the repository root::
    ...
    python3 scripts/quality_score/p2_gsjso/qs_cheap_refine_sweep.py run
...
METRIC_SCRIPT = REPO / "scripts/e5_c001/p2_gsjso/e5_c001_8way.py"
SMOOTH_SCRIPT = REPO / "scripts/evidence_and_attributes/p2_gsjso/overseg_smooth.py"
D_SCRIPT = REPO / "scripts/quality_score/p2_gsjso/qs_cheap_refine_pilot.py"
GATE_SCRIPT = REPO / "scripts/e5_c001/_shared/e5_pilot_gate_tools.py"
...
def finalize() -> None:
    ...
    gate = load_module(
        "qs_cheap_sweep_gate",
        REPO / "scripts/e5_c001/_shared/e5_pilot_gate_tools.py",
    )
