...
SOURCE_A_MANIFEST = REPO / "phases/p2-gsjso/runs/quality_score/20260716_qs_rescore/manifest.json"
SOURCE_FIXED_MANIFEST = (
    REPO / "phases/p2-gsjso/runs/quality_score/20260717_qs_rescore_fixed_conditions/manifest.json"
)
...
def write_report(
    ...
    lines = [
        ...
        "- 지붕면은 `scripts/e5_c001/p2_gsjso/e5_c001_8way.py`의 "
        ...
        "",
        "- 코드 경로: `scripts/e5_c001/p2_gsjso/e5_c001_8way.py`의 "
