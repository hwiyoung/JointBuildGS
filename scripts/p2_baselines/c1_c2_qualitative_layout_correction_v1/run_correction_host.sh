...
OUTPUT_REL="phase-payloads/p2-baselines/c1_c2_qualitative_layout_correction_r5_v1/P2-C1-C2-QUALITATIVE-LAYOUT-CORRECTION-R5-v1"
...
if [[ "${RUN_ID}" != "P2-C1-C2-QUALITATIVE-LAYOUT-CORRECTION-R5-RUN-v1" \
