...
| exact base·cache/input hash·raw dtype/shape·create-only half-once·raw audit 재계산 | `e5_c001_s3_semantic_guided.py` | 구현·전체 S3 관련 46 tests 통과 |
| 1k 게이트 실행·CSV | `docs/e5_c001_s3_loss_gate_audit.csv` | **428뷰 strict loader preflight 통과, 게이트 config 생성 전·미실행** |
...
|---|---:|---:|---|---|
| gate | 2001 | 2,500 | 0.25 smooth + 0.25 plane + 0.01 nb @1.5k | **428뷰 cache·T0-1·loader preflight 완료, config 생성 전·미실행** |
