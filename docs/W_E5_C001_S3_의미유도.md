...
| 1k 게이트 실행·CSV | `docs/e5_c001_s3_loss_gate_audit.csv` | **428뷰 strict loader preflight·gate/full config 3개 생성 완료, 게이트 미실행** |
...
|---|---:|---:|---|---|
| gate | 2001 | 2,500 | 0.25 smooth + 0.25 plane + 0.01 nb @1.5k | **config·manifest·versions 생성 완료, 미실행** |
