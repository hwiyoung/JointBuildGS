...
|---|---|---|
| `세션핸드오프_모집단잠금·기준문서_20260702.md` §1·§2 | 없음 | `docs/SESSION_HANDOFF.md`, `docs/population_verify.md`, `docs/experiments/w_report_evidence/reports/W_report_evidence.md` |
| `P2_실험기록_20260629.md` | 없음 | `docs/experiments/w_phase_b_structure/reports/W_phaseB_structure.md`, `docs/experiments/w_observability/reports/W_observability_inventory.md`, `docs/W_observability_test.md`, `docs/experiments/w_d12_metric/reports/W_D12_metric_final.md` |
| `원격발주_투영fix·LS정합·재게이트·재계산체인_레시피감사_20260702.md` Task B | 없음 | `docs/experiments/projection_datum/reports/projection_geoid_rootcause.md`, `docs/experiments/projection_datum/reports/projection_datum_fix.md`, `configs/projection_datum.json`, `phases/p2-gsjso/runs/20260702_*`, `phases/p2-gsjso/runs/20260703_*` |
...
| 실험 기록 | `docs/experiments/w_generation_8way/reports/W_generation_8way.md`, `docs/W_opacity_diag.md`, `docs/experiments/w_d_prior_full/reports/W_D_prior_full.md`, `docs/experiments/w_d4/reports/W_D4.md`, `docs/experiments/w_d5/reports/W_D5.md`, `docs/W_D6_prior_provenance.md`, `docs/experiments/w_d6_overseg_diag/reports/W_D6_overseg_diag.md`, `docs/experiments/w_observability/reports/W_observability_inventory.md`, `docs/W_observability_test.md`, `docs/experiments/w_d12_metric/reports/W_D12_metric_final.md`, `docs/experiments/w_results_consolidation/reports/W_results_consolidation.md`, `docs/experiments/w_report_evidence/reports/W_report_evidence.md`, `docs/SESSION_HANDOFF.md` |
...
|---|---|---|
| `v5` | 현재 checkout에 `v5` config/run 이름은 없다. `docs/experiments/w_generation_8way/reports/W_generation_8way.md`와 `analysis_pack_v6/versions.txt` 기준으로는 `v6`부터 추적 가능. | 매핑 불가 라벨. 숫자 인용 시 config/run명을 직접 써야 한다. |
...
| `D9` | `docs/experiments/w_observability/reports/W_observability_inventory.md` 기준 `overseg-faithfulness`. D4/D5 output과 기존 점군을 분석. | 새 ckpt 없음. `face_support()` 분석 자산명으로만 유지. |
