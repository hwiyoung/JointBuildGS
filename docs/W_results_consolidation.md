...
### (a) 원 주장 — `docs/W_D_prior_full.md` §2 (조립 회복 = read-out 단독)
...
### (b) 정정/철회 — `docs/W_D2_D3.md` (분류+학습 초가산적 시너지)
...
출처: (a) `docs/W_D_prior_full.md` §0·§2 · (b) `docs/W_D2_D3.md` D2 "관찰 — 초가산적 시너지". 원문 그대로 인용.
