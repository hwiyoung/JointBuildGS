...
- Root file `원격발주_투영fix·LS정합·재게이트·재계산체인_레시피감사_20260702.md` was not present in this checkout; this A0 follows `CLAUDE.md`, `docs/experiments/input-and-alignment/projection_datum/reports/projection_geoid_rootcause.md`, and the retracted `docs/projection_gate.md` note.
