...
- Full table: `docs/experiments/e5_pilot/reports/e5_seed_constant_gate.md`
...
- Diff proof: `docs/experiments/e5_pilot/reports/e5_gs_sparse_config_diff.md`
...
Ground-patch material from `docs/experiments/e5_pilot/reports/e5_baseline_preflight.md`:
