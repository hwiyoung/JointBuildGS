...
| `docs/experiments/input-and-alignment/phase2_synthesis/reports/REPORT.md` | 16 | ../../scripts/phase2_synthesis/render_scene.py | `docs/experiments/scripts/phase2_synthesis/render_scene.py` |
...
| `docs/experiments/input-and-alignment/phase2_synthesis/reports/REPORT.md` | 36 | ../../scripts/phase2_synthesis/compose_scene.py | `docs/experiments/scripts/phase2_synthesis/compose_scene.py` |
