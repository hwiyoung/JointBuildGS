...
All 21 source files were clean tracked files, all targets were collision-free, and payload bytes were preserved. The untracked/ignored nightly runtime tree remains under `reports/`; the rest of `results/` remains in place because it co-locates compact evidence with large class-C/D payloads and active writer paths.
