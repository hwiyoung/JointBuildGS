...
This decision does not cover large payload-bearing roots such as `data/`, `results/`, `reports/`, or `fair-pilot/`. Their raw/generated bytes remain in place until their class-C backend or class-D workspace policy is approved.
