...
- `docs/judgment_kit_v4/*.png`: 수동판정 4칸 카드 44장.
- 비차단 시간차 locator: 2장.
- manifest: `docs/judgment_kit_v4/manifest.csv`.
- locator neighbor rings: min=2, lt2=0.
- footprint shape flags: `docs/footprint_shape_flags.csv` (44동, small=13, elong=1).
