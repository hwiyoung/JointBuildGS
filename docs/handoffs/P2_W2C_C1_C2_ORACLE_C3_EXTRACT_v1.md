# P2 C1/C2 oracle 및 C3 Gaussian/Roofer 비교판 복구 recovery v12 — LOCAL EXECUTION AUTHORITY

- task_id: `P2-C1-C2-ORACLE-C3-EXTRACT-RECOVERY-v12`
- handoff_id: `null`
- execution_record_id: `P2-LOCAL-C1-C2-ORACLE-C3-EXTRACT-RECOVERY-v12`
...
## recovery-v12 C3 진단 read-out과 비교판
...
- Recovery-v12 Roofer invocation: `0` (recovery-v11 partial의 completed 4건 hash-verified inheritance)
- Recovery-v12 rendered-depth C3 extraction invocation: `0` (recovery-v9 completed extraction hash-verified inheritance)
- Recovery-v12 roof-only mesh postprocess: `0` (recovery-v9 completed mesh hash-verified inheritance)
- pre-Roofer reference alignment failures: `2`
- output: fresh add-once namespace
  `artifact://JointBuildGS/phase-payloads/p2/c1_c2_oracle_c3_extract_recovery_v12/P2-C1-C2-ORACLE-C3-EXTRACT-RECOVERY-v12`
