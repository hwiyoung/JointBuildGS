...
| `P2-W2C-GATE-S0-REMEDIATION-R1-v1` | P2/S0 | Work→Codex | v1 | `DRAFT / EXECUTION FORBIDDEN` | `TO_BE_FILLED_BY_USER_BEFORE_APPROVAL` | `docs/handoffs/returns/P2_C2W_GATE_S0_REMEDIATION_R1_RETURN_v1.md` | — | pending |
