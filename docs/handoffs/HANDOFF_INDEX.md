...
| `P2-W2C-GATE-S0-COMMON-BASE-LINEAGE-R2B-v1` | P2/S0 | Work→Codex | v1 | `APPROVED_FOR_EXECUTION / OFFER PENDING` | `150796bc7e928fc108082b2048878e86d5820981` | `docs/handoffs/returns/P2_C2W_GATE_S0_COMMON_BASE_LINEAGE_R2B_RETURN_v1.md` | — | `GRANTED — 2026-08-01` |
