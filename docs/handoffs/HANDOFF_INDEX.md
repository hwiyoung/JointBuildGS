...
| `P2-W2C-GATE-S0-PREP-v1` | P2/S0 | Work→Codex | v1 | `DRAFT / SOURCE_SNAPSHOT_PENDING` | `TO_BE_FILLED_BY_APPROVAL_COMMIT` | `docs/handoffs/returns/P2_C2W_GATE_S0_PREPARATION_RETURN_v1.md` | — | `NOT_GRANTED` |
...
반환됐다. Gate S0 DRAFT는 exact source snapshot, approval, offered/accepted receipts와
