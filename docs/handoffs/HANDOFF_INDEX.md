...
| `P2-W2C-GATE-S0-EVIDENCE-R2A-v1` | P2/S0 | Work→Codex | v1 | `DRAFT / NOT EXECUTABLE` | `TO_BE_FILLED_BY_USER_BEFORE_APPROVAL` | `docs/handoffs/returns/P2_C2W_GATE_S0_EVIDENCE_R2A_RETURN_v1.md` | — | `NOT_GRANTED` |
