...
| `P2-W2C-GATE-S0-COMMON-BASE-LINEAGE-R2B-v1` | P2/S0 | Work→Codex | v1 | `BLOCKED_FOR_GATE_S0_TECHNICAL_AND_HUMAN_FREEZE / TECHNICAL_CLOSED@b5532e6d` | `150796bc7e928fc108082b2048878e86d5820981` | `docs/handoffs/returns/P2_C2W_GATE_S0_COMMON_BASE_LINEAGE_R2B_RETURN_v1.md` | — | `GRANTED — 2026-08-01` |
| `P2-W2C-GATE-S0-INTEGRATED-FREEZE-CLOSURE-v1` | P2/S0 | Work→Codex | v1 | `APPROVED_FOR_EXECUTION / OFFER PENDING` | `f3e0be62a67605727f0470c6373e0d78ea590ebb` | `docs/handoffs/returns/P2_C2W_GATE_S0_INTEGRATED_FREEZE_CLOSURE_v1.md` | — | standing authorization — 2026-08-01 |
| `P2-W2C-C1-C2-FEASIBILITY-PILOT-v1` | P2 | Work→Codex | v1 | `APPROVED_FOR_EXECUTION / OFFER PENDING` | `d5265d9afbe9afcd49e2bedd5900c3026f7a3b2f` | `docs/handoffs/returns/P2_C2W_C1_C2_FEASIBILITY_PILOT_RETURN_v1.md` | — | `DEC-P1-013` — 2026-08-02 |
