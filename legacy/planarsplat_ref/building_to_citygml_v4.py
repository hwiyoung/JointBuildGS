...
def build_cityjson(building_id, groups, polygons, out_dir):
    ...
    # If none, label the face with the most downward-pointing normal as Ground.
    # In COLMAP convention (-Y up), downward = +Y normal.
    ...
    if not has_ground:
        ...
        if surface_data[best_idx]['normal'][1] > 0.3:  # reasonably downward
